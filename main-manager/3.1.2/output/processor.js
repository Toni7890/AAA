...
/***/ "./node_modules/@microchip/main-basic-interface/lib/api.js":
/*!*****************************************************************!*\
  !*** ./node_modules/@microchip/main-basic-interface/lib/api.js ***!
  \*****************************************************************/
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.createPrototypeExport = exports.createPrototypeImport = exports.getInterfaceId = void 0;
var interfaceId_1 = __webpack_require__(/*! ./interfaceId */ "./node_modules/@microchip/main-basic-interface/lib/interfaceId.js");
exports.getInterfaceId = function () {
    return interfaceId_1.interfaceId;
};
...
/***/ "./node_modules/@microchip/main-basic-interface/lib/interfaceId.js":
/*!*************************************************************************!*\
  !*** ./node_modules/@microchip/main-basic-interface/lib/interfaceId.js ***!
  \*************************************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.interfaceId = void 0;
exports.interfaceId = {
    name: "main-basic-interface",
    version: "1.0.0",
};
...
/***/ "./node_modules/@microchip/main-basic-interface/lib/main-basic-interface.js":
/*!**********************************************************************************!*\
  !*** ./node_modules/@microchip/main-basic-interface/lib/main-basic-interface.js ***!
  \**********************************************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.Interface = exports.sortrunInLoopCode = exports.runInloopPrioritySorter = exports.sortInitializers = exports.initPrioritySorter = exports.RUNINLOOP_PRIORITY = exports.INIT_PRIORITY = void 0;
var mock_1 = __webpack_require__(/*! ./mock */ "./node_modules/@microchip/main-basic-interface/lib/mock.js");
var api_1 = __webpack_require__(/*! ./api */ "./node_modules/@microchip/main-basic-interface/lib/api.js");
var INIT_PRIORITY;
(function (INIT_PRIORITY) {
    INIT_PRIORITY[INIT_PRIORITY["START"] = 1] = "START";
    INIT_PRIORITY[INIT_PRIORITY["PRE_SYSTEM_INIT"] = 50] = "PRE_SYSTEM_INIT";
    INIT_PRIORITY[INIT_PRIORITY["SYSTEM_INIT"] = 100] = "SYSTEM_INIT";
    INIT_PRIORITY[INIT_PRIORITY["POST_SYSTEM_INIT"] = 150] = "POST_SYSTEM_INIT";
    INIT_PRIORITY[INIT_PRIORITY["DEFAULT"] = 200] = "DEFAULT";
    INIT_PRIORITY[INIT_PRIORITY["LIBRARIES"] = 300] = "LIBRARIES";
    INIT_PRIORITY[INIT_PRIORITY["END"] = 400] = "END";
})(INIT_PRIORITY = exports.INIT_PRIORITY || (exports.INIT_PRIORITY = {}));
var RUNINLOOP_PRIORITY;
(function (RUNINLOOP_PRIORITY) {
    RUNINLOOP_PRIORITY[RUNINLOOP_PRIORITY["HIGH"] = 1] = "HIGH";
    RUNINLOOP_PRIORITY[RUNINLOOP_PRIORITY["DEFAULT"] = 100] = "DEFAULT";
    RUNINLOOP_PRIORITY[RUNINLOOP_PRIORITY["LOW"] = 200] = "LOW";
})(RUNINLOOP_PRIORITY = exports.RUNINLOOP_PRIORITY || (exports.RUNINLOOP_PRIORITY = {}));
/** Sorting initializer based on the priority. */
exports.initPrioritySorter = function (a, b) {
    var _a, _b, _c, _d;
    var result = 0;
    var apriority = (_a = a === null || a === void 0 ? void 0 : a.initializer.priority) !== null && _a !== void 0 ? _a : INIT_PRIORITY.DEFAULT;
    var bpriority = (_b = b === null || b === void 0 ? void 0 : b.initializer.priority) !== null && _b !== void 0 ? _b : INIT_PRIORITY.DEFAULT;
    if (apriority < bpriority) {
        ...
        result = (_d = (_c = a === null || a === void 0 ? void 0 : a.initializer.name) === null || _c === void 0 ? void 0 : _c.localeCompare(b === null || b === void 0 ? void 0 : b.initializer.name)) !== null && _d !== void 0 ? _d : 0;
    }
    return result;
};
/**Creating list - sorted initialize */
exports.sortInitializers = function (data) {
    var initializers = __spreadArrays(data);
    var initList = [];
    //iterating initialize[]
    for (var _i = 0, initializers_1 = initializers; _i < initializers_1.length; _i++) {
        var entry = initializers_1[_i];
        if (entry.initialize) {
            for (var _a = 0, _b = entry.initialize; _a < _b.length; _a++) {
                var subentry = _b[_a];
                var temp = {
                    initializer: __assign(__assign({}, subentry), { isNewInterface: true }),
                };
                initList.push(temp);
            }
        }
    }
    initList.sort(exports.initPrioritySorter);
    return initList;
};
/** Sorting runInloopCode based on the priority. */
exports.runInloopPrioritySorter = function (a, b) {
    var _a, _b, _c, _d;
    var result = 0;
    var apriority = (_a = a === null || a === void 0 ? void 0 : a.runInLoopSection.priority) !== null && _a !== void 0 ? _a : RUNINLOOP_PRIORITY.DEFAULT;
    var bpriority = (_b = b === null || b === void 0 ? void 0 : b.runInLoopSection.priority) !== null && _b !== void 0 ? _b : RUNINLOOP_PRIORITY.DEFAULT;
    if (apriority < bpriority) {
        result = -1;
    }
    else if (apriority > bpriority) {
        ...
        //same priority sort via intializer name alphabetically
        result = (_d = (_c = a === null || a === void 0 ? void 0 : a.runInLoopSection.name) === null || _c === void 0 ? void 0 : _c.localeCompare(b === null || b === void 0 ? void 0 : b.runInLoopSection.name)) !== null && _d !== void 0 ? _d : 0;
    }
    return result;
};
/**Creating list - sorted sortrunInLoopCode */
exports.sortrunInLoopCode = function (data) {
    var LoopCode = __spreadArrays(data);
    var runInLoopCodeList = [];
    //iterating runInLoopCode[]
    for (var _i = 0, LoopCode_1 = LoopCode; _i < LoopCode_1.length; _i++) {
        var entry = LoopCode_1[_i];
        if (entry.runInLoopCode) {
            for (var _a = 0, _b = entry.runInLoopCode; _a < _b.length; _a++) {
                var subentry = _b[_a];
                var temp = {
                    runInLoopSection: __assign(__assign({}, subentry), { isNewInterface: true }),
                };
                runInLoopCodeList.push(temp);
            }
        }
    }
    runInLoopCodeList.sort(exports.runInloopPrioritySorter);
    return runInLoopCodeList;
};
exports.Interface = {
    createPrototypeExport: api_1.createPrototypeExport,
    createPrototypeImport: api_1.createPrototypeImport,
    getInterfaceId: api_1.getInterfaceId,
    createMock: mock_1.createMock,
};


/***/ }),

/***/ "./node_modules/@microchip/main-basic-interface/lib/mock.js":
/*!******************************************************************!*\
  !*** ./node_modules/@microchip/main-basic-interface/lib/mock.js ***!
  \******************************************************************/
/*! no static exports found */
...
var api_1 = __webpack_require__(/*! ./api */ "./node_modules/@microchip/main-basic-interface/lib/api.js");
var main_basic_interface_1 = __webpack_require__(/*! ./main-basic-interface */ "./node_modules/@microchip/main-basic-interface/lib/main-basic-interface.js");
// export const createMock = (): ProcessedExportInterface => {
//     return {
//         interfaceId: getInterfaceId(),
//         payload: {
//             moduleName: "Module",
//             interfaceApi: getInterfaceApiStructure("Module"),
//         },
//         args: {},
//         results: {},
//     };
...
exports.createMock = function () {
    return {
        interfaceId: api_1.getInterfaceId(),
        payload: {},
        args: {},
        results: {
            requestId: {
                initialize: [
                    {
                        ...
                        priority: main_basic_interface_1.INIT_PRIORITY.START,
                    },
                ],
                runInLoopCode: [
                    {
                        name: "//Enable the Global Interrupts \r\n //INTERRUPT_GlobalInterruptEnable();",
                        header: {
                            name: "mymodule.h",
                            path: "include/",
                        },
                        priority: main_basic_interface_1.RUNINLOOP_PRIORITY.DEFAULT,
                    },
                ],
            },
        },
...
/***/ "./node_modules/@microchip/melody-automodule-interface/lib/src/DerivedFunctions.js":
/*!*****************************************************************************************!*\
  !*** ./node_modules/@microchip/melody-automodule-interface/lib/src/DerivedFunctions.js ***!
  \*****************************************************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.TABID = exports.COMPTYPE = void 0;
/**
 * This interface contains function prototypes
 * @interface DerivedFunctions
 */
var COMPTYPE;
(function (COMPTYPE) {
    COMPTYPE["SOFTWARE"] = "SW";
    COMPTYPE["REGISTER"] = "REG";
    COMPTYPE["INTERRUPT"] = "INT";
    COMPTYPE["SETTING"] = "SET";
})(COMPTYPE = exports.COMPTYPE || (exports.COMPTYPE = {}));
var TABID;
(function (TABID) {
    TABID["MAIN"] = "main";
    TABID["REGISTER"] = "register";
})(TABID = exports.TABID || (exports.TABID = {}));
//# sourceMappingURL=DerivedFunctions.js.map
...
var MyAppModel = /** @class */ (function () {
    ...
    MyAppModel.prototype.getComponentValue = function (componentName, componentMeta) {
        return this.getAutoModuleAppModel().getComponentValue(componentName, componentMeta);
    };
    return MyAppModel;
}());
...
var RegisterEditorHelper_1 = __webpack_require__(/*! ./registerEditor/RegisterEditorHelper */ "./node_modules/@microchip/scf-automodule-impl/lib/autoModule/registerEditor/RegisterEditorHelper.js");
...
var MyAutoModuleAppModel = /** @class */ (function () {
    ...
    MyAutoModuleAppModel.prototype.getComponentValue = function (componentName, componentMeta) {
        var _a, _b, _c, _d;
        if (((_b = (_a = this.model.getState()) === null || _a === void 0 ? void 0 : _a.contentMeta) === null || _b === void 0 ? void 0 : _b.isUserEnRegRWMode) === true) {
            var res = (0, RegisterEditorHelper_1.getRegisterComponentValue)(this.model, componentName, componentMeta);
            return res !== undefined ? res : (_c = this.getComponent(componentName)) === null || _c === void 0 ? void 0 : _c.value;
        }
        return (_d = this.getComponent(componentName)) === null || _d === void 0 ? void 0 : _d.value;
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.getFriendlyInterfaceId = exports.getModuleDefaultDescription = exports.DependencySelector = exports.populateLoadedFiles = exports.getProcessedHandle = exports.filterModeOptions = exports.getSettingOptionsIfPresent = exports.getOverrideDefaultValue = exports.getSettingDefaultIfPresent = exports.getOptionValueByName = exports.getSettingFromComponent = exports.getSettingBits = exports.sortComments = exports.getRegisterValues = exports.hasConfigBits = exports.getComboOptions = exports.getDefaultValue = exports.castComponent = void 0;
...
var getRegisterValues = function (model, interfaceName) {
    ...
    if (((_b = (_a = model.getState()) === null || _a === void 0 ? void 0 : _a.contentMeta) === null || _b === void 0 ? void 0 : _b.isUserEnRegRWMode) === true) {
        return (0, RegisterEditorHelper_1.getRegisterEditorValues)(model, interfaceName);
    }
    var registers = {};
    var config = (0, getConfigData_1.getConfigData)(model);
    interfaceName = (0, exports.getFriendlyInterfaceId)(interfaceName);
    var isUserEnRegRWMode = (_e = (_d = (_c = model.getState()) === null || _c === void 0 ? void 0 : _c.contentMeta) === null || _d === void 0 ? void 0 : _d.isUserEnRegRWMode) !== null && _e !== void 0 ? _e : false;
    (_f = config === null || config === void 0 ? void 0 : config.peripherals) === null || _f === void 0 ? void 0 : _f.forEach(function (peripheral) {
        var _a, _b, _c;
        ...
        (_c = (0, Utils_1.getKeys)((_b = peripheral.registers) !== null && _b !== void 0 ? _b : {})) === null || _c === void 0 ? void 0 : _c.forEach(function (regName) {
            ...
            (_d = peripheral.registers) === null || _d === void 0 ? void 0 : _d[regName].forEach(function (set) {
                ...
                if (setting) {
                    if (setting.type !== "R") {
                        //Add Comments
                        if (isUserEnRegRWMode) {
                            var readOnlySetVal = (_d = (_c = (_b = model.getState()) === null || _b === void 0 ? void 0 : _b.register) === null || _c === void 0 ? void 0 : _c[reg.name]) === null || _d === void 0 ? void 0 : _d[setting.name];
                            comments.push(readOnlySetVal !== undefined ? "".concat(set.setting, " ").concat(readOnlySetVal, "; ") : "".concat(set.setting, " ").concat(model.getComponentValue(set.name), "; "));
                        }
                        else {
                    ...
                    if (registerValue === null || registerValue === void 0 ? void 0 : registerValue.settings) {
                        if (isUserEnRegRWMode) {
                            var settingVal = (_g = (_f = (_e = model.getState()) === null || _e === void 0 ? void 0 : _e.register) === null || _f === void 0 ? void 0 : _f[reg.name]) === null || _g === void 0 ? void 0 : _g[setting.name];
                            registerValue.settings[setting.alias] = (0, exports.getSettingBits)(reg, setting, (settingVal !== undefined ? settingVal : (_h = model.getComponent(set.name)) === null || _h === void 0 ? void 0 : _h.value), (_j = config === null || config === void 0 ? void 0 : config.deviceType) !== null && _j !== void 0 ? _j : "PIC");
                        }
                        else {
                            registerValue.settings[setting.alias] = (0, exports.getSettingBits)(reg, setting, (_k = model.getComponent(set.name)) === null || _k === void 0 ? void 0 : _k.value, (_l = config === null || config === void 0 ? void 0 : config.deviceType) !== null && _l !== void 0 ? _l : "PIC");
                        }
                    }
                    switch (set.type) {
                        case "ComboBox":
                        case "boolean":
                            if (isUserEnRegRWMode) {
                                var setVal = (_p = (_o = (_m = model.getState()) === null || _m === void 0 ? void 0 : _m.register) === null || _o === void 0 ? void 0 : _o[reg.name]) === null || _p === void 0 ? void 0 : _p[setting.name];
                                registerVal.withNumberValue(setting, (_r = (0, exports.getOptionValueByName)(setting, (setVal !== undefined ? setVal : (_q = model.getComponent(set.name)) === null || _q === void 0 ? void 0 : _q.value))) !== null && _r !== void 0 ? _r : 0);
                            }
                            else {
                                registerVal.withNumberValue(setting, (_t = (0, exports.getOptionValueByName)(setting, (_s = model.getComponent(set.name)) === null || _s === void 0 ? void 0 : _s.value)) !== null && _t !== void 0 ? _t : 0);
                            }
                            break;
                        case "number":
                            if (isUserEnRegRWMode) {
                                var numberSetVal = (_w = (_v = (_u = model.getState()) === null || _u === void 0 ? void 0 : _u.register) === null || _v === void 0 ? void 0 : _v[reg.name]) === null || _w === void 0 ? void 0 : _w[setting.name];
                                registerVal.withNumberValue(setting, (numberSetVal !== undefined ? numberSetVal : model.getComponentValue(set.name)));
                            }
                            else {
                        ...
                        case "string":
                            if (isUserEnRegRWMode) {
                                var regOrStringSetVal = (_z = (_y = (_x = model.getState()) === null || _x === void 0 ? void 0 : _x.register) === null || _y === void 0 ? void 0 : _y[reg.name]) === null || _z === void 0 ? void 0 : _z[setting.name];
                                if (regOrStringSetVal !== undefined) {
                                    if (setting.options) {
                                        registerVal.withNumberValue(setting, (_0 = (0, exports.getOptionValueByName)(setting, regOrStringSetVal)) !== null && _0 !== void 0 ? _0 : 0);
                                    }
                                    else {
                                        registerVal.withNumberValue(setting, Number(regOrStringSetVal));
                                    }
                                }
                                else {
            ...
            if (reg.settings) {
                ...
                if (isUserEnRegRWMode) {
                    var regVal = (_f = (_e = model.getState()) === null || _e === void 0 ? void 0 : _e.register) === null || _f === void 0 ? void 0 : _f[reg.name];
                    registerValue.value = Number(regVal !== undefined ? regVal : (_l = model.getComponentValue((_k = (_j = (_h = (_g = peripheral.registers) === null || _g === void 0 ? void 0 : _g[regName]) === null || _h === void 0 ? void 0 : _h[0]) === null || _j === void 0 ? void 0 : _j.name) !== null && _k !== void 0 ? _k : "")) !== null && _l !== void 0 ? _l : 0);
                }
                else {
                    registerValue.value = Number((_r = model.getComponentValue((_q = (_p = (_o = (_m = peripheral.registers) === null || _m === void 0 ? void 0 : _m[regName]) === null || _o === void 0 ? void 0 : _o[0]) === null || _p === void 0 ? void 0 : _p.name) !== null && _q !== void 0 ? _q : "")) !== null && _r !== void 0 ? _r : 0);
                }
            ...
            registerValue.comment = (0, exports.sortComments)(comments, reg);
            registers[(_s = reg === null || reg === void 0 ? void 0 : reg.alias) !== null && _s !== void 0 ? _s : reg.name] = registerValue;
        });
    });
    return registers;
};
...
var getSettingBits = function (register, setting, value, deviceType) {
    ...
    if (option) {
        setValNumber = Number((_a = option === null || option === void 0 ? void 0 : option.value) !== null && _a !== void 0 ? _a : 0);
        valueAsDesc = value;
    }
    else {
        setValNumber = Number(value);
        valueAsDesc = "0x" + Number(value).toString(16).toUpperCase();
    }
    var settingValue = {
        alias: setting.alias,
        name: setting.name,
        ...
        valueAsDescription: valueAsDesc,
        type: setting.type,
...
/***/ "./node_modules/@microchip/scf-automodule-impl/lib/autoModule/registerEditor/RegisterEditorHelper.js":
/*!***********************************************************************************************************!*\
  !*** ./node_modules/@microchip/scf-automodule-impl/lib/autoModule/registerEditor/RegisterEditorHelper.js ***!
  \***********************************************************************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.getRegisterEditorValues = exports.getRegisterKey = exports.getRegisterNameList = exports.getRegisterComponentValue = void 0;
var DerivedFunctions_1 = __webpack_require__(/*! @microchip/melody-automodule-interface/lib/src/DerivedFunctions */ "./node_modules/@microchip/melody-automodule-interface/lib/src/DerivedFunctions.js");
var Utils_1 = __webpack_require__(/*! ../../Utils */ "./node_modules/@microchip/scf-automodule-impl/lib/Utils.js");
var getConfigData_1 = __webpack_require__(/*! ../getConfigData */ "./node_modules/@microchip/scf-automodule-impl/lib/autoModule/getConfigData.js");
var AutoModuleHelpers_1 = __webpack_require__(/*! ../AutoModuleHelpers */ "./node_modules/@microchip/scf-automodule-impl/lib/autoModule/AutoModuleHelpers.js");
var CalculateRegisterValue_1 = __importDefault(__webpack_require__(/*! @microchip/scf-device/lib/CalculateRegisterValue */ "./node_modules/@microchip/scf-device/lib/CalculateRegisterValue.js"));
var getRegisterComponentValue = function (model, componentName, componentMeta) {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _0, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10;
    var harwareRegister = (_a = model.getHardware()) === null || _a === void 0 ? void 0 : _a.getPeripheral().registers;
    var hardwareInterrupts = (_b = model.getHardware()) === null || _b === void 0 ? void 0 : _b.getPeripheral().interrupts;
    var registerList = (_d = getRegisterNameList((_c = model.getHardware()) === null || _c === void 0 ? void 0 : _c.getPeripheral().registers)) !== null && _d !== void 0 ? _d : [];
    var interruptList = (_e = Object.keys(hardwareInterrupts !== null && hardwareInterrupts !== void 0 ? hardwareInterrupts : {})) !== null && _e !== void 0 ? _e : [];
    // For Registers value
    if (registerList.indexOf(componentName) !== -1 && componentMeta === undefined) {
        var registerValues = model.getRegisterValues();
        var registerKey = (_f = getRegisterKey(registerValues, componentName)) !== null && _f !== void 0 ? _f : "";
        var deviceDeafultValue = Number((_g = harwareRegister === null || harwareRegister === void 0 ? void 0 : harwareRegister[registerKey]) === null || _g === void 0 ? void 0 : _g.defaultValue);
        var registerValue = (_h = registerValues === null || registerValues === void 0 ? void 0 : registerValues[registerKey]) === null || _h === void 0 ? void 0 : _h.value;
        if (registerValue !== undefined) {
            return registerValue;
        }
        return deviceDeafultValue;
    }
    // For Interrupt value
    if (interruptList.indexOf(componentName) !== -1) {
        var overriddenCompValue = (_k = (_j = model.getDerivedFunctions()).overrideDefaultValues) === null || _k === void 0 ? void 0 : _k.call(_j, componentName);
        if (overriddenCompValue !== undefined) {
            return overriddenCompValue;
        }
        var stateData = (_o = (_m = (_l = model.getState()) === null || _l === void 0 ? void 0 : _l.register) === null || _m === void 0 ? void 0 : _m.interrupts) === null || _o === void 0 ? void 0 : _o[componentName];
        var interruptComponentValue = (_p = model.getComponent(componentName.toLowerCase())) === null || _p === void 0 ? void 0 : _p.value;
        if (stateData !== undefined) {
            return stateData;
        }
        if (interruptComponentValue === false) {
            return "disabled";
        }
        else if (interruptComponentValue === true) {
            return "enabled";
        }
        return "disabled";
    }
    // For setting value in a register of componentMeta
    if (componentMeta && registerList.indexOf(componentMeta.register) !== -1) {
        // componentMetaData send to overrideDefaultValues for knowing register and tab information
        var componentMetaData = {
            compType: DerivedFunctions_1.COMPTYPE.SETTING,
            tabID: DerivedFunctions_1.TABID.REGISTER,
            parent: componentMeta.register
        };
        var overriddenCompValue = (_r = (_q = model.getDerivedFunctions()).overrideDefaultValues) === null || _r === void 0 ? void 0 : _r.call(_q, componentName, componentMetaData);
        if (overriddenCompValue != undefined) {
            return overriddenCompValue;
        }
        var registerKey = (_s = getRegisterKey(harwareRegister, componentMeta.register)) !== null && _s !== void 0 ? _s : "";
        var stateData = (_v = (_u = (_t = model.getState()) === null || _t === void 0 ? void 0 : _t.register) === null || _u === void 0 ? void 0 : _u[componentMeta.register]) === null || _v === void 0 ? void 0 : _v[componentName];
        if (stateData !== undefined) {
            return stateData;
        }
        var registerValues = model.getRegisterValues();
        var settingValue = (_y = (_x = (_w = registerValues === null || registerValues === void 0 ? void 0 : registerValues[registerKey]) === null || _w === void 0 ? void 0 : _w.settings) === null || _x === void 0 ? void 0 : _x[componentName]) === null || _y === void 0 ? void 0 : _y.value;
        var deviceDefaultValue = Number((_1 = (_0 = (_z = harwareRegister === null || harwareRegister === void 0 ? void 0 : harwareRegister[registerKey]) === null || _z === void 0 ? void 0 : _z.settings) === null || _0 === void 0 ? void 0 : _0[componentName]) === null || _1 === void 0 ? void 0 : _1.defaultValue);
        if (((_4 = (_3 = (_2 = harwareRegister === null || harwareRegister === void 0 ? void 0 : harwareRegister[registerKey]) === null || _2 === void 0 ? void 0 : _2.settings) === null || _3 === void 0 ? void 0 : _3[componentName]) === null || _4 === void 0 ? void 0 : _4.options) !== undefined) {
            settingValue = (_6 = (_5 = registerValues === null || registerValues === void 0 ? void 0 : registerValues[registerKey]) === null || _5 === void 0 ? void 0 : _5.settings) === null || _6 === void 0 ? void 0 : _6[componentName].optionName;
            deviceDefaultValue = (_10 = (_9 = (_8 = (_7 = harwareRegister === null || harwareRegister === void 0 ? void 0 : harwareRegister[registerKey]) === null || _7 === void 0 ? void 0 : _7.settings) === null || _8 === void 0 ? void 0 : _8[componentName]) === null || _9 === void 0 ? void 0 : _9.defaultValue) !== null && _10 !== void 0 ? _10 : "";
        }
        if (settingValue !== undefined) {
            return settingValue;
        }
        return deviceDefaultValue;
    }
    return undefined;
};
exports.getRegisterComponentValue = getRegisterComponentValue;
function getRegisterNameList(registers) {
    var _a;
    var registerList = [];
    (_a = (0, Utils_1.getKeys)(registers !== null && registers !== void 0 ? registers : {})) === null || _a === void 0 ? void 0 : _a.forEach(function (registerName) {
        var _a;
        var eachRegObj = registers === null || registers === void 0 ? void 0 : registers[registerName];
        var name = (_a = eachRegObj === null || eachRegObj === void 0 ? void 0 : eachRegObj.name) !== null && _a !== void 0 ? _a : "";
        registerList.push(name);
    });
    return registerList;
}
exports.getRegisterNameList = getRegisterNameList;
function getRegisterKey(registersValueObjects, registerInstanceName) {
    var _a;
    var result;
    (_a = (0, Utils_1.getKeys)(registersValueObjects !== null && registersValueObjects !== void 0 ? registersValueObjects : {})) === null || _a === void 0 ? void 0 : _a.forEach(function (registerName) {
        var _a;
        var eachRegObj = registersValueObjects === null || registersValueObjects === void 0 ? void 0 : registersValueObjects[registerName];
        var name = (_a = eachRegObj === null || eachRegObj === void 0 ? void 0 : eachRegObj.name) !== null && _a !== void 0 ? _a : "";
        if (name === registerInstanceName) {
            result = registerName;
        }
    });
    return result;
}
exports.getRegisterKey = getRegisterKey;
var getRegisterEditorValues = function (model, interfaceName) {
    var _a;
    var registers = {};
    var config = (0, getConfigData_1.getConfigData)(model);
    interfaceName = (0, AutoModuleHelpers_1.getFriendlyInterfaceId)(interfaceName);
    (_a = config === null || config === void 0 ? void 0 : config.peripherals) === null || _a === void 0 ? void 0 : _a.forEach(function (peripheral) {
        var _a, _b, _c;
        var peripheralName = (_a = (0, AutoModuleHelpers_1.getFriendlyInterfaceId)(peripheral.interfaceId.name)) !== null && _a !== void 0 ? _a : "";
        if ((0, AutoModuleHelpers_1.hasConfigBits)(peripheralName))
            return;
        if ((interfaceName != undefined && peripheralName !== interfaceName) ||
            !peripheral.registers)
            return;
        (_c = (0, Utils_1.getKeys)((_b = peripheral.registers) !== null && _b !== void 0 ? _b : {})) === null || _c === void 0 ? void 0 : _c.forEach(function (regName) {
            ...
            (_d = peripheral.registers) === null || _d === void 0 ? void 0 : _d[regName].forEach(function (set) {
                ...
                if (setting) {
                    if (setting.type !== "R") {
                        ...
                        var overriddenCompValue = (_c = (_b = model.getDerivedFunctions()).overrideDefaultValues) === null || _c === void 0 ? void 0 : _c.call(_b, setting.name, componentMetaData);
                        var settingVal = overriddenCompValue !== undefined ? overriddenCompValue : (_f = (_e = (_d = model.getState()) === null || _d === void 0 ? void 0 : _d.register) === null || _e === void 0 ? void 0 : _e[reg.name]) === null || _f === void 0 ? void 0 : _f[setting.name];
                        comments.push(settingVal !== undefined ? "".concat(set.setting, " ").concat(settingVal, "; ") : "".concat(set.setting, " ").concat(model.getComponentValue(set.name), "; "));
                    }
                    if (registerValue === null || registerValue === void 0 ? void 0 : registerValue.settings) {
                        var componentMetaData = {
                            compType: DerivedFunctions_1.COMPTYPE.SETTING,
                        ...
                        var overriddenCompValue = (_h = (_g = model.getDerivedFunctions()).overrideDefaultValues) === null || _h === void 0 ? void 0 : _h.call(_g, setting.name, componentMetaData);
                        var settingVal = overriddenCompValue !== undefined ? overriddenCompValue : (_l = (_k = (_j = model.getState()) === null || _j === void 0 ? void 0 : _j.register) === null || _k === void 0 ? void 0 : _k[reg.name]) === null || _l === void 0 ? void 0 : _l[setting.name];
                        registerValue.settings[setting.alias] = (0, AutoModuleHelpers_1.getSettingBits)(reg, setting, (settingVal !== undefined ? settingVal : (_m = model.getComponent(set.name)) === null || _m === void 0 ? void 0 : _m.value), (_o = config === null || config === void 0 ? void 0 : config.deviceType) !== null && _o !== void 0 ? _o : "PIC");
                    }
                    switch (set.type) {
                        case "ComboBox":
                        case "boolean":
                            {
                                ...
                                var overriddenCompValue = (_q = (_p = model.getDerivedFunctions()).overrideDefaultValues) === null || _q === void 0 ? void 0 : _q.call(_p, setting.name, componentMetaData);
                                var settingVal = overriddenCompValue !== undefined ? overriddenCompValue : (_t = (_s = (_r = model.getState()) === null || _r === void 0 ? void 0 : _r.register) === null || _s === void 0 ? void 0 : _s[reg.name]) === null || _t === void 0 ? void 0 : _t[setting.name];
                                registerVal.withNumberValue(setting, (_v = (0, AutoModuleHelpers_1.getOptionValueByName)(setting, (settingVal !== undefined ? settingVal : (_u = model.getComponent(set.name)) === null || _u === void 0 ? void 0 : _u.value))) !== null && _v !== void 0 ? _v : 0);
                            }
                            break;
                        case "number":
                            {
                                ...
                                var overriddenCompValue = (_x = (_w = model.getDerivedFunctions()).overrideDefaultValues) === null || _x === void 0 ? void 0 : _x.call(_w, setting.name, componentMetaData);
                                var settingVal = overriddenCompValue !== undefined ? overriddenCompValue : (_0 = (_z = (_y = model.getState()) === null || _y === void 0 ? void 0 : _y.register) === null || _z === void 0 ? void 0 : _z[reg.name]) === null || _0 === void 0 ? void 0 : _0[setting.name];
                                registerVal.withNumberValue(setting, (settingVal !== undefined ? settingVal : model.getComponentValue(set.name)));
                            }
                            break;
                        case "register":
                        case "string":
                            {
                                ...
                                var overriddenCompValue = (_2 = (_1 = model.getDerivedFunctions()).overrideDefaultValues) === null || _2 === void 0 ? void 0 : _2.call(_1, setting.name, componentMetaData);
                                var settingVal = overriddenCompValue !== undefined ? overriddenCompValue : (_5 = (_4 = (_3 = model.getState()) === null || _3 === void 0 ? void 0 : _3.register) === null || _4 === void 0 ? void 0 : _4[reg.name]) === null || _5 === void 0 ? void 0 : _5[setting.name];
                                if (settingVal !== undefined) {
                                    if (setting.options) {
                                        registerVal.withNumberValue(setting, (_6 = (0, AutoModuleHelpers_1.getOptionValueByName)(setting, settingVal)) !== null && _6 !== void 0 ? _6 : 0);
                                    }
                                    else {
                                        registerVal.withNumberValue(setting, Number(settingVal));
                                    }
                                }
                                else {
                                    registerVal.withNumberValue(setting, Number(model.getComponentValue(set.name)));
            ...
            registerValue.valueAsHex =
                "0x" + registerValue.value.toString(16).toUpperCase();
            registerValue.comment = (0, AutoModuleHelpers_1.sortComments)(comments, reg);
            registers[(_m = reg === null || reg === void 0 ? void 0 : reg.alias) !== null && _m !== void 0 ? _m : reg.name] = registerValue;
        });
    });
    return registers;
};
exports.getRegisterEditorValues = getRegisterEditorValues;
//# sourceMappingURL=RegisterEditorHelper.js.map
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.registerUiSchema = exports.registerFormData = exports.registerScfUiSchema = exports.createAutoViewPayloads = void 0;
...
var createAutoViewPayloads = function (model) {
    ...
    function getPayloadForTab(tab) {
        ...
        if (tab === "register") {
            if (((_b = (_a = model.getState()) === null || _a === void 0 ? void 0 : _a.contentMeta) === null || _b === void 0 ? void 0 : _b.isUserEnRegRWMode) == true) {
                return createSimpleFormPayloadForRegisterEditor();
            }
    ...
    // Form payload for Register Editor
    function createSimpleFormPayloadForRegisterEditor() {
        if (!(config === null || config === void 0 ? void 0 : config.peripherals)) {
            return {};
        }
        var registerViewPayloads = [];
        config.peripherals.forEach(function (peripheral) {
            ...
            var interrupts = model.getInterrupts();
            hardwarePeripheral = registerFilter.processRegisterModes(peripheral, hardwarePeripheral, model);
            var registerView = scf_register_view_helper_1.CreateRegisterView.for(hardwarePeripheral).withAllEditable();
            if (registerValues) {
                (_b = (0, Utils_1.getKeys)(registerValues !== null && registerValues !== void 0 ? registerValues : {})) === null || _b === void 0 ? void 0 : _b.forEach(function (registerName) {
                    var _a;
                    var foundRegister = (_a = hardwarePeripheral === null || hardwarePeripheral === void 0 ? void 0 : hardwarePeripheral.registers) === null || _a === void 0 ? void 0 : _a[registerName];
            ...
            registerViewPayloads.push(__assign(__assign({}, registerView.create()), { formData: registerFormData(model, registerView.create().formData), uiSchema: registerUiSchema(model, registerView, hardwarePeripheral.registers, hardwarePeripheral.interrupts), scfUiSchema: (0, exports.registerScfUiSchema)(model, hardwarePeripheral.registers) }));
        });
        return registerViewPayloads[0];
    }
};
exports.createAutoViewPayloads = createAutoViewPayloads;
var registerScfUiSchema = function (model, hardwareRegisters) {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
    var scfUiSchema = {};
    ...
    var helpUrl = "";
    if (deviceMeta && hasSdlSupport) {
        if ((_b = deviceMeta.architecture) === null || _b === void 0 ? void 0 : _b.startsWith("PIC")) {
            helpUrl = "v2/keyword-lookup?keyword=atmel;device:${deviceName};register:${registerName}&redirect=true";
        }
        else if ((_c = deviceMeta.architecture) === null || _c === void 0 ? void 0 : _c.startsWith("AVR")) {
            helpUrl = "v2/keyword-lookup?keyword=atmel;device:${deviceName};comp:${moduleName}_${dosId};register:${registerName}&redirect=true";
        }
        var deviceName_1 = (_d = deviceMeta === null || deviceMeta === void 0 ? void 0 : deviceMeta.deviceName) !== null && _d !== void 0 ? _d : "";
        var moduleName_1 = (_g = (_f = (_e = model.getHardware()) === null || _e === void 0 ? void 0 : _e.getPeripheral()) === null || _f === void 0 ? void 0 : _f.group) !== null && _g !== void 0 ? _g : "";
        var dosid_1 = (_k = (_j = (_h = model.getHardware()) === null || _h === void 0 ? void 0 : _h.getPeripheral()) === null || _j === void 0 ? void 0 : _j.dosid) !== null && _k !== void 0 ? _k : "";
        if (hardwareRegisters != undefined) {
            (0, Utils_1.values)(hardwareRegisters !== null && hardwareRegisters !== void 0 ? hardwareRegisters : {}).forEach(function (eachRegister) {
                var _a, _b;
                if (eachRegister) {
                    var settings_1 = (_b = hardwareRegisters[(_a = eachRegister.alias) !== null && _a !== void 0 ? _a : ""]) === null || _b === void 0 ? void 0 : _b.settings;
                    if (settings_1) {
                        (0, Utils_1.getKeys)(settings_1).forEach(function (eachSetting) {
                            var _a, _b;
                            var _c;
                            var eachSettingObject = settings_1[eachSetting];
                            if (eachSettingObject) {
                                var sdlHelpUrl = helpUrl
                                    .replace("${deviceName}", deviceName_1 !== null && deviceName_1 !== void 0 ? deviceName_1 : "")
                                    .replace("${registerName}", eachRegister.name)
                                    .replace("${moduleName}", moduleName_1 !== null && moduleName_1 !== void 0 ? moduleName_1 : "")
                                    .replace("${dosId}", dosid_1 !== null && dosid_1 !== void 0 ? dosid_1 : "");
                                scfUiSchema = __assign(__assign({}, scfUiSchema), (_a = {}, _a[eachRegister.name] = __assign(__assign({}, scfUiSchema[eachRegister.name]), (_b = {}, _b[eachSettingObject.name] = __assign(__assign({}, (_c = scfUiSchema[eachRegister.name]) === null || _c === void 0 ? void 0 : _c[eachSettingObject.name]), { helpKeyword: sdlHelpUrl, tooltip: "Click for more Information" }), _b)), _a));
                            }
                        });
                    }
                }
...
exports.registerScfUiSchema = registerScfUiSchema;
function registerFormData(model, formData) {
    var _a, _b;
    var formDataCopy = __assign({}, formData);
    for (var _i = 0, _c = Object.keys(formDataCopy); _i < _c.length; _i++) {
        var register = _c[_i];
        for (var _d = 0, _e = Object.keys(formDataCopy[register]); _d < _e.length; _d++) {
            var setting = _e[_d];
            formData = __assign(__assign({}, formData), (_a = {}, _a[register] = __assign(__assign({}, formData[register]), (_b = {}, _b[setting] = model.getComponentValue(setting, { register: register }), _b)), _a));
        }
    }
    return formData;
}
exports.registerFormData = registerFormData;
function registerUiSchema(model, registerView, hardwareRegisters, hardwareInterrupt) {
    if (hardwareRegisters != undefined) {
        // For Registers and Settings
        (0, Utils_1.getKeys)(hardwareRegisters !== null && hardwareRegisters !== void 0 ? hardwareRegisters : {}).forEach(function (eachRegister) {
            var _a, _b, _c, _d, _e, _f, _g;
            var componentMetaData = {
                compType: DerivedFunctions_1.COMPTYPE.REGISTER,
                tabID: DerivedFunctions_1.TABID.REGISTER,
            };
            var registerName = (_b = (_a = hardwareRegisters[eachRegister]) === null || _a === void 0 ? void 0 : _a.name) !== null && _b !== void 0 ? _b : "";
            // isEnabled for each Register in device.
            var isEnabled = (_d = model === null || model === void 0 ? void 0 : (_c = model.getDerivedFunctions()).isEnabled) === null || _d === void 0 ? void 0 : _d.call(_c, registerName, componentMetaData);
            if (isEnabled === false) {
                registerView = registerView.withNonEditableRegister(hardwareRegisters[eachRegister]);
            }
            var settings = (_e = hardwareRegisters[eachRegister]) === null || _e === void 0 ? void 0 : _e.settings;
            (0, Utils_1.getKeys)(settings !== null && settings !== void 0 ? settings : {}).forEach(function (eachSetting) {
                var _a, _b, _c, _d;
                var eachSettingObject = settings === null || settings === void 0 ? void 0 : settings[eachSetting];
                if (eachSettingObject) {
                    var settingName = eachSettingObject.name;
                    var componentMetaData_1 = {
                        compType: DerivedFunctions_1.COMPTYPE.SETTING,
                        tabID: DerivedFunctions_1.TABID.REGISTER,
                        parent: registerName
                    };
                    // isEnabled for each Register's Settings in device.
                    var isEnabled_1 = (_b = model === null || model === void 0 ? void 0 : (_a = model.getDerivedFunctions()).isEnabled) === null || _b === void 0 ? void 0 : _b.call(_a, settingName, componentMetaData_1);
                    if (eachSettingObject && settingName && isEnabled_1 === false) {
                        registerView = registerView.withEditableRegisterSetting(hardwareRegisters === null || hardwareRegisters === void 0 ? void 0 : hardwareRegisters[eachRegister], eachSettingObject);
                    }
                    // isVisible for each Register's Settings in device.
                    var isVisible_1 = (_d = model === null || model === void 0 ? void 0 : (_c = model.getDerivedFunctions()).isVisible) === null || _d === void 0 ? void 0 : _d.call(_c, settingName, componentMetaData_1);
                    if (eachSettingObject && settingName && isVisible_1 === false) {
                        registerView = registerView.withInVisibleRegisterSetting(hardwareRegisters === null || hardwareRegisters === void 0 ? void 0 : hardwareRegisters[eachRegister], eachSettingObject);
                    }
                }
            });
            // isVisible for each Register in device.
            var isVisible = (_g = model === null || model === void 0 ? void 0 : (_f = model.getDerivedFunctions()).isVisible) === null || _g === void 0 ? void 0 : _g.call(_f, registerName, componentMetaData);
            if (isVisible === false) {
                registerView = registerView.withInVisibleRegister(hardwareRegisters[eachRegister]);
            }
        });
        // For interrupts
        (0, Utils_1.getKeys)(hardwareInterrupt !== null && hardwareInterrupt !== void 0 ? hardwareInterrupt : {}).forEach(function (eachInterrupts) {
            var _a, _b, _c, _d;
            var componentMetaData = {
                compType: DerivedFunctions_1.COMPTYPE.INTERRUPT,
                tabID: DerivedFunctions_1.TABID.REGISTER,
            };
            // isEnabled for each Interrupts in device.
            var isEnabled = (_b = model === null || model === void 0 ? void 0 : (_a = model.getDerivedFunctions()).isEnabled) === null || _b === void 0 ? void 0 : _b.call(_a, eachInterrupts, componentMetaData);
            if (isEnabled === false) {
                registerView = registerView.withNonEditableInterrupt(hardwareInterrupt === null || hardwareInterrupt === void 0 ? void 0 : hardwareInterrupt[eachInterrupts]);
            }
            // isVisible for each Interrupts in device.
            var isVisible = (_d = model === null || model === void 0 ? void 0 : (_c = model.getDerivedFunctions()).isVisible) === null || _d === void 0 ? void 0 : _d.call(_c, eachInterrupts, componentMetaData);
            if (isVisible === false) {
                registerView = registerView.withInVisibleInterrupt(hardwareInterrupt === null || hardwareInterrupt === void 0 ? void 0 : hardwareInterrupt[eachInterrupts]);
            }
        });
    }
    return registerView.create().uiSchema;
}
...
var process = function (initialModule, stage, getDerivedData) {
    ...
    processedOutput = __assign(__assign({}, processedOutput), { showRegisterEditor: (0, getConfigData_1.getConfigData)(model).showRegisterEditor });
    switch (stage) {
        case "arguments":
...
var CreateRegisterView = /** @class */ (function () {
    function CreateRegisterView(module) {
        ...
        /** Make a setting in the given register and setting readonly based on setting*/
        this.withEditableRegisterSetting = function (register, setting) {
            if (register && setting) {
                if ((setting === null || setting === void 0 ? void 0 : setting.type) === "R") {
                    _this.getSafeSettingViewModel(register, setting).setReadonly(true);
                }
        ...
        this.withInVisibleRegister = function (register) {
            var _a, _b;
            _this.getSafeRegisterViewModel(register).setIsVisible(false);
            if (register) {
                (_b = (0, Arrays_1.values)((_a = register === null || register === void 0 ? void 0 : register.settings) !== null && _a !== void 0 ? _a : {})) === null || _b === void 0 ? void 0 : _b.forEach(function (setting) {
                    _this.getSafeSettingViewModel(register, setting).setIsVisible(false);
                });
            }
            return _this;
        };
        this.withInVisibleRegisterSetting = function (register, setting) {
            if (register && setting) {
                _this.getSafeSettingViewModel(register, setting).setIsVisible(false);
            }
            return _this;
        };
        /** Make register non-editable*/
        this.withNonEditableRegister = function (register) {
            _this.getSafeRegisterViewModel(register).setReadonly(true);
            return _this;
        };
        ...
        /** Make a given interrupt Invisible */
        this.withInVisibleInterrupt = function (interrupt) {
            _this.getSafeInterruptViewModel(interrupt).setIsVisible(false);
            return _this;
        };
        /** Make a given interrupt non-editable */
        this.withNonEditableInterrupt = function (interrupt) {
            _this.getSafeInterruptViewModel(interrupt).setReadonly(true);
            return _this;
        };
    ...
    CreateRegisterView.prototype.getNoOptionsViewSchema = function (setting) {
        ...
        var uiSchemaBuilder = new ViewSchemaBuilder_1.UiSchemaBuilder()
            ...
            .withWidget(!setting.getIsVisible() ? "hidden" : undefined)
    ...
    CreateRegisterView.prototype.createInterruptViewSchema = function (interrupt) {
        ...
        var uiSchemaBuilder = new ViewSchemaBuilder_1.UiSchemaBuilder()
            .withReadonlyValue(interrupt.getIsReadonly())
            .withWidget(!interrupt.getIsVisible() ? "hidden" : undefined);
        return {
            schema: schema.build(),
            uiSchema: uiSchemaBuilder.build(),
    ...
    CreateRegisterView.prototype.getBinarySettingUiSchema = function (setting) {
        ...
        return new ViewSchemaBuilder_1.UiSchemaBuilder()
            .withReadonlyValue(setting.getIsReadonly())
            .withWidget(!setting.getIsVisible() ? "hidden" : "radio")
            .withUiHelp("".concat(setting.getName(), ": ") + ((_a = setting.getDescription()) !== null && _a !== void 0 ? _a : ""))
...
var InterruptViewModel = /** @class */ (function () {
    function InterruptViewModel(interrupt) {
        ...
        this.getIsVisible = function () { return _this.isVisible; };
        this.setReadonly = function (isReadOnly) {
            _this.isReadOnly = isReadOnly;
        };
        this.setIsVisible = function (visibility) {
            _this.isVisible = visibility;
        };
        if (!interrupt) {
...
var RegisterViewModel = /** @class */ (function () {
    function RegisterViewModel(register) {
        ...
        this.setIsVisible = function (visibility) {
            _this.forEachSetting(function (setting) { return setting.setReadonly(visibility); });
        };
...
/*!****************************!*\
  !*** ./src/DerivedData.ts ***!
  \****************************/
/*! exports provided: getDerivedData, EmptyDerivedData, MyDerivedData */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getDerivedData", function() { return getDerivedData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EmptyDerivedData", function() { return EmptyDerivedData; });
...
/* harmony import */ var _microchip_main_basic_interface_lib_main_basic_interface__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @microchip/main-basic-interface/lib/main-basic-interface */ "./node_modules/@microchip/main-basic-interface/lib/main-basic-interface.js");
/* harmony import */ var _microchip_main_basic_interface_lib_main_basic_interface__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_microchip_main_basic_interface_lib_main_basic_interface__WEBPACK_IMPORTED_MODULE_3__);
...
var MyDerivedData = function MyDerivedData(dataModel) {
  ...
  _defineProperty(this, "initMainList", []);

  _defineProperty(this, "initSectionList", []);

  _defineProperty(this, "runInloopList", []);

  _defineProperty(this, "main_basic_interface_runInloopList", []);

  _defineProperty(this, "main_basic_interface_InitializerList", []);

  _defineProperty(this, "getMyFunctions", function () {
    return {
      moduleName: _this.getModuleName,
      templateData: _this.getTemplateData,
  ...
  _defineProperty(this, "friendlyImportName", function (importKey) {
    if (importKey === "main") return "main-manager";
    return importKey;
  });
  ...
  _defineProperty(this, "getTemplateData", function () {
    var initializer_main_initializers = _this.getInitSystemList();

    var initSection = _this.getInitSectionList();

    var initializer_main_runInLoopList = _this.getRuninLoopCode();

    _this.getMainBasicInterfaceRuninLoopSectionList();

    _this.getMainBasicInterfaceInitializeList();

    var runInLoopList = [].concat(_toConsumableArray(initializer_main_runInLoopList), _toConsumableArray(_this.main_basic_interface_runInloopList));
    var initializers = [].concat(_toConsumableArray(initializer_main_initializers), _toConsumableArray(_this.main_basic_interface_InitializerList), _toConsumableArray(initSection));
    var sortedRunInLoopList = Object(_microchip_main_basic_interface_lib_main_basic_interface__WEBPACK_IMPORTED_MODULE_3__["sortrunInLoopCode"])(runInLoopList);
    var sortedInitalizeList = Object(_microchip_main_basic_interface_lib_main_basic_interface__WEBPACK_IMPORTED_MODULE_3__["sortInitializers"])(initializers);

    var initHeaderList = _this.getHeaderListFromInitResults(sortedInitalizeList);

    var runInLoopHeaderList = _this.getHeaderListFromrunInLoopResults(sortedRunInLoopList);

    var headerList = [].concat(_toConsumableArray(initHeaderList), _toConsumableArray(runInLoopHeaderList));
    return {
      initCodeList: sortedInitalizeList,
      headerList: _this.removeDuplicatesFromHeaderList(headerList),
      runInLoopList: sortedRunInLoopList,
      moduleNameLowerCase: "main",
      moduleNameUpperCase: "MAIN",
      PackageVersion: "3.1.2"
    };
  });

  _defineProperty(this, "removeDuplicatesFromHeaderList", function (mergedHeaderList) {
    var headerList = [];
    mergedHeaderList.forEach(function (entry) {
      /** find duplicate name and path */
      var existingHeader = Object(_microchip_scf_device_lib_util_Arrays__WEBPACK_IMPORTED_MODULE_1__["find"])(headerList, function (header) {
        return entry.name === header.name && entry.path === header.path;
      });
  ...
  _defineProperty(this, "getMainBasicInterfaceInitializeList", function () {
    var _this$dataModel$getEx, _this$dataModel$getEx2, _this$dataModel$getEx3;

    var exports = (_this$dataModel$getEx = _this.dataModel.getExports()) === null || _this$dataModel$getEx === void 0 ? void 0 : (_this$dataModel$getEx2 = _this$dataModel$getEx.main_basic_interface) === null || _this$dataModel$getEx2 === void 0 ? void 0 : (_this$dataModel$getEx3 = _this$dataModel$getEx2.interfaces[0]) === null || _this$dataModel$getEx3 === void 0 ? void 0 : _this$dataModel$getEx3.results;
    Object(_generated_module_src_Utils__WEBPACK_IMPORTED_MODULE_2__["values"])(exports !== null && exports !== void 0 ? exports : {}).forEach(function (result) {
      if (result !== undefined) {
        if (result.initialize) {
          _this.main_basic_interface_InitializerList.push(result);
        }
      }
    });
    return _this.main_basic_interface_InitializerList;
  });

  _defineProperty(this, "appendPriority", function (initializer_main_List) {
    var newInterfaceList = [];
    Object(_generated_module_src_Utils__WEBPACK_IMPORTED_MODULE_2__["values"])(initializer_main_List !== null && initializer_main_List !== void 0 ? initializer_main_List : {}).forEach(function (result) {
      if (result !== undefined) {
        if (result.runInLoopCode && result.runInLoopCode.length > 0) {
          if (result.runInLoopCode) {
            newInterfaceList.push({
              runInLoopCode: [{
                name: String(result.runInLoopCode),
                priority: _microchip_main_basic_interface_lib_main_basic_interface__WEBPACK_IMPORTED_MODULE_3__["RUNINLOOP_PRIORITY"].DEFAULT
              }]
            });
          }
        }
  ...
  _defineProperty(this, "getMainBasicInterfaceRuninLoopSectionList", function () {
    var _this$dataModel$getEx4, _this$dataModel$getEx5, _this$dataModel$getEx6;

    var exports = (_this$dataModel$getEx4 = _this.dataModel.getExports()) === null || _this$dataModel$getEx4 === void 0 ? void 0 : (_this$dataModel$getEx5 = _this$dataModel$getEx4.main_basic_interface) === null || _this$dataModel$getEx5 === void 0 ? void 0 : (_this$dataModel$getEx6 = _this$dataModel$getEx5.interfaces[0]) === null || _this$dataModel$getEx6 === void 0 ? void 0 : _this$dataModel$getEx6.results;
    Object(_generated_module_src_Utils__WEBPACK_IMPORTED_MODULE_2__["values"])(exports !== null && exports !== void 0 ? exports : {}).forEach(function (result) {
      if (result !== undefined) {
        if (result.runInLoopCode && result.runInLoopCode.length > 0) {
          _this.main_basic_interface_runInloopList.push(result);
        }
      }
    });
    return _this.main_basic_interface_runInloopList;
  });

  _defineProperty(this, "getHeaderListFromInitResults", function (list) {
    var headerList = [];
    list === null || list === void 0 ? void 0 : list.forEach(function (entry) {
      var existingHeader = Object(_microchip_scf_device_lib_util_Arrays__WEBPACK_IMPORTED_MODULE_1__["find"])(headerList, function (header) {
        var _entry$initializer$he, _entry$initializer$he2;

        return ((_entry$initializer$he = entry.initializer.header) === null || _entry$initializer$he === void 0 ? void 0 : _entry$initializer$he.name) === (header === null || header === void 0 ? void 0 : header.name) && ((_entry$initializer$he2 = entry.initializer.header) === null || _entry$initializer$he2 === void 0 ? void 0 : _entry$initializer$he2.path) === (header === null || header === void 0 ? void 0 : header.path);
      });

      if (!existingHeader) {
        if (entry.initializer.header) {
          headerList.push(entry.initializer.header);
        }
      }
    });
    return headerList;
  ...
  _defineProperty(this, "getHeaderListFromrunInLoopResults", function (list) {
    var headerList = [];
    list === null || list === void 0 ? void 0 : list.forEach(function (entry) {
      var existingHeader = Object(_microchip_scf_device_lib_util_Arrays__WEBPACK_IMPORTED_MODULE_1__["find"])(headerList, function (header) {
        var _entry$runInLoopSecti, _entry$runInLoopSecti2;

        return ((_entry$runInLoopSecti = entry.runInLoopSection.header) === null || _entry$runInLoopSecti === void 0 ? void 0 : _entry$runInLoopSecti.name) === (header === null || header === void 0 ? void 0 : header.name) && ((_entry$runInLoopSecti2 = entry.runInLoopSection.header) === null || _entry$runInLoopSecti2 === void 0 ? void 0 : _entry$runInLoopSecti2.path) === (header === null || header === void 0 ? void 0 : header.path);
      });

      if (!existingHeader) {
        if (entry.runInLoopSection.header) {
          headerList.push(entry.runInLoopSection.header);
        }
      }
    });
    return headerList;
  ...
  _defineProperty(this, "getRuninLoopSectionList", function () {
    var _this$dataModel$getEx7, _this$dataModel$getEx8, _this$dataModel$getEx9;

    var exports = (_this$dataModel$getEx7 = _this.dataModel.getExports()) === null || _this$dataModel$getEx7 === void 0 ? void 0 : (_this$dataModel$getEx8 = _this$dataModel$getEx7.initializer_main) === null || _this$dataModel$getEx8 === void 0 ? void 0 : (_this$dataModel$getEx9 = _this$dataModel$getEx8.interfaces[0]) === null || _this$dataModel$getEx9 === void 0 ? void 0 : _this$dataModel$getEx9.results;
    Object(_generated_module_src_Utils__WEBPACK_IMPORTED_MODULE_2__["values"])(exports !== null && exports !== void 0 ? exports : {}).forEach(function (res) {
      if (res !== undefined) {
        if (res.runInLoopCode && res.runInLoopCode.length > 0) {
          _this.runInloopList.push(res);
        }
      }
    });
    return _this.runInloopList;
  });

  _defineProperty(this, "getRuninLoopCode", function () {
    return _this.appendPriority(_this.getRuninLoopSectionList());
  });

  _defineProperty(this, "getInitSectionList", function () {
    var _this$dataModel$getEx10, _this$dataModel$getEx11, _this$dataModel$getEx12, _values;

    var exports = (_this$dataModel$getEx10 = _this.dataModel.getExports()) === null || _this$dataModel$getEx10 === void 0 ? void 0 : (_this$dataModel$getEx11 = _this$dataModel$getEx10.initializer_main) === null || _this$dataModel$getEx11 === void 0 ? void 0 : (_this$dataModel$getEx12 = _this$dataModel$getEx11.interfaces[0]) === null || _this$dataModel$getEx12 === void 0 ? void 0 : _this$dataModel$getEx12.results;
    (_values = Object(_generated_module_src_Utils__WEBPACK_IMPORTED_MODULE_2__["values"])(exports !== null && exports !== void 0 ? exports : {})) === null || _values === void 0 ? void 0 : _values.forEach(function (res) {
      if (res !== undefined) {
        var _res$initSection, _res$initSection2;

        if ((res === null || res === void 0 ? void 0 : res.initSection) && (res === null || res === void 0 ? void 0 : (_res$initSection = res.initSection) === null || _res$initSection === void 0 ? void 0 : _res$initSection.message) && (res === null || res === void 0 ? void 0 : (_res$initSection2 = res.initSection) === null || _res$initSection2 === void 0 ? void 0 : _res$initSection2.message.length) > 0) {
          _this.initSectionList.push(res);
        }
      }
    });
    return _this.appendInitPriorityForInitSection(_this.initSectionList);
  });

  _defineProperty(this, "appendInitPriorityForInitSection", function (initializer_main_List) {
    var newInterfaceList = [];
    Object(_generated_module_src_Utils__WEBPACK_IMPORTED_MODULE_2__["values"])(initializer_main_List !== null && initializer_main_List !== void 0 ? initializer_main_List : {}).forEach(function (result) {
      if (result !== undefined) {
        if (result.initSection) {
          if (result.initSection.message) {
            newInterfaceList.push({
              initialize: [{
                name: String(result.initSection.message),
                priority: _microchip_main_basic_interface_lib_main_basic_interface__WEBPACK_IMPORTED_MODULE_3__["INIT_PRIORITY"].DEFAULT
              }]
            });
          }
        }
  ...
  _defineProperty(this, "getInitSystemList", function () {
    var _this$dataModel$getEx13, _this$dataModel$getEx14, _this$dataModel$getEx15, _values2;

    var exports = (_this$dataModel$getEx13 = _this.dataModel.getExports()) === null || _this$dataModel$getEx13 === void 0 ? void 0 : (_this$dataModel$getEx14 = _this$dataModel$getEx13.initializer_main) === null || _this$dataModel$getEx14 === void 0 ? void 0 : (_this$dataModel$getEx15 = _this$dataModel$getEx14.interfaces[0]) === null || _this$dataModel$getEx15 === void 0 ? void 0 : _this$dataModel$getEx15.results;
    (_values2 = Object(_generated_module_src_Utils__WEBPACK_IMPORTED_MODULE_2__["values"])(exports !== null && exports !== void 0 ? exports : {})) === null || _values2 === void 0 ? void 0 : _values2.forEach(function (res) {
      if (res !== undefined) {
        var _res$initializer, _res$initializer2;

        if ((res === null || res === void 0 ? void 0 : (_res$initializer = res.initializer) === null || _res$initializer === void 0 ? void 0 : _res$initializer.name) && (res === null || res === void 0 ? void 0 : (_res$initializer2 = res.initializer) === null || _res$initializer2 === void 0 ? void 0 : _res$initializer2.name.length) > 0) {
          _this.initMainList.push(res);
        }
      }
    });
    return _this.appendInitPriority(_this.initMainList);
  });

  _defineProperty(this, "appendInitPriority", function (initializer_main_List) {
    var newInterfaceList = [];
    Object(_generated_module_src_Utils__WEBPACK_IMPORTED_MODULE_2__["values"])(initializer_main_List !== null && initializer_main_List !== void 0 ? initializer_main_List : {}).forEach(function (result) {
      if (result !== undefined) {
        if (result.initializer) {
          if (result.initializer) {
            if (result.initializer.name === "SYSTEM_Initialize") {
              newInterfaceList.push({
                initialize: [{
                  name: String(result.initializer.name + "();"),
                  priority: _microchip_main_basic_interface_lib_main_basic_interface__WEBPACK_IMPORTED_MODULE_3__["INIT_PRIORITY"].SYSTEM_INIT,
                  header: result.initializer.header
                }]
              });
            } else {
              newInterfaceList.push({
  ...
  _defineProperty(this, "getApiPrefixList", function () {
    var _this$dataModel$getEx16, _this$dataModel$getEx17, _this$dataModel$getEx18, _values3;

    var apiPrefixList = [];
    var exports = (_this$dataModel$getEx16 = _this.dataModel.getExports()) === null || _this$dataModel$getEx16 === void 0 ? void 0 : (_this$dataModel$getEx17 = _this$dataModel$getEx16.api_prefix_registration) === null || _this$dataModel$getEx17 === void 0 ? void 0 : (_this$dataModel$getEx18 = _this$dataModel$getEx17.interfaces[0]) === null || _this$dataModel$getEx18 === void 0 ? void 0 : _this$dataModel$getEx18.results;
    (_values3 = Object(_generated_module_src_Utils__WEBPACK_IMPORTED_MODULE_2__["values"])(exports !== null && exports !== void 0 ? exports : {})) === null || _values3 === void 0 ? void 0 : _values3.forEach(function (module) {
      if (module) {
        apiPrefixList.push({
  ...
  _defineProperty(this, "getMyAlerts", function () {
    ...
    var apiPrefixList = _this.getApiPrefixList();

    var mapOfApi = {};

    if (apiPrefixList) {
      var _iterator = _createForOfIteratorHelper(apiPrefixList),
          _step;
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          if (mapOfApi[api.apiPrefix] === undefined) {
            mapOfApi[api.apiPrefix] = [];
          }

          mapOfApi[api.apiPrefix].push(api.moduleName);
        }
      } catch (err) {
        _iterator.e(err);
      } finally {
    ...
    if (mapOfApi) {
      for (var eachApi in mapOfApi) {
        var _mapOfApi$eachApi;

        if (((_mapOfApi$eachApi = mapOfApi[eachApi]) === null || _mapOfApi$eachApi === void 0 ? void 0 : _mapOfApi$eachApi.length) > 1) {
          alerts.push({
            type: _microchip_scf_common_lib_Processor__WEBPACK_IMPORTED_MODULE_0__["AlertTypes"].Warning,
            text: "Duplicate Custom Name definition (" + eachApi + ") found for modules " + mapOfApi[eachApi].join(", ")
          });
        }
      }
    }
...
/*!*******************************!*\
  !*** ./src/moduleConfig.json ***!
  \*******************************/
/*! exports provided: moduleName, deviceType, booleanValues, UIGroups, UIOrder, tabs, templates, help, imports, exports, softwareData, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"moduleName\":\"Main\",\"deviceType\":\"PIC\",\"booleanValues\":{\"true\":\"enabled\",\"false\":\"disabled\"},\"UIGroups\":{\"software\":\"Software Settings\"},\"UIOrder\":{\"software\":[\"*\"]},\"tabs\":{\"main\":\"Easy View\"},\"templates\":[{\"src\":\"output/main-template.c.ftl\",\"dest\":\".././main.c\"}],\"help\":{\"url\":\"v2/keyword-lookup?keyword=main-manager&redirect=true\",\"tooltip\":\"The main-manager provides the system drivers/ other peripheral drivers/ libraries initializer code to generate in the main.c file which is added to the Project.\"},\"imports\":{\"main\":{\"import\":{\"interfaceId\":{\"name\":\"main-manager\",\"version\":\"^1.*\"},\"isRequired\":true}}},\"exports\":{\"main_basic_interface\":{\"interfaces\":[{\"nodeModule\":{\"importName\":\"main_basic_interface\",\"node\":\"@microchip/main-basic-interface\"},\"fullyTyped\":true,\"interfaceId\":{\"name\":\"main-basic-interface\",\"version\":\"1.0.0\"}}]},\"initializer_main\":{\"interfaces\":[{\"nodeModule\":{\"importName\":\"initializer_main\",\"node\":\"@microchip/initializer-main\"},\"fullyTyped\":true,\"interfaceId\":{\"name\":\"initializer-main\",\"version\":\"0.4.0\"}}]},\"api_prefix_registration\":{\"interfaces\":[{\"nodeModule\":{\"importName\":\"api_prefix_registration\",\"node\":\"@microchip/api-prefix-registration\"},\"fullyTyped\":true,\"interfaceId\":{\"name\":\"api-prefix-registration\",\"version\":\"0.1.0\"}}]}},\"softwareData\":{\"generateMain\":{\"name\":\"generateMain\",\"description\":\"Generate main.c file\",\"defaultValue\":true,\"type\":\"boolean\",\"group\":\"software\",\"tabs\":[\"main\"],\"uiBehavior\":{\"readonly\":true},\"category\":\"software\"},\"componentName\":{\"name\":\"componentName\",\"description\":\"Custom Name\",\"type\":\"string\",\"defaultValue\":\"main\",\"group\":\"software\",\"tabs\":[\"main\"],\"isVisibleProperty\":\"false\",\"category\":\"software\"}}}");
