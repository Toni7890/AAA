...
function createScfUiSchema(tab, config, model) {
    ...
    var scfUiSchema = {};
    if (config) {
        var components = getAllComponents(model);
        (_a = (0, Utils_1.values)(components)) === null || _a === void 0 ? void 0 : _a.forEach(function (entry) {
            var _a, _b, _c, _d;
            var component = entry.component;
            ...
            if (component.category === "table") {
                var tableState = (_d = (_c = (_b = model === null || model === void 0 ? void 0 : model.getState()) === null || _b === void 0 ? void 0 : _b[tab]) === null || _c === void 0 ? void 0 : _c[group]) === null || _d === void 0 ? void 0 : _d[name];
                ...
                colNames.forEach(function (name) {
                    ...
                    columns_1.push({
                        ...
                        headerAlign: displayHeadersDiagonally_1
                            ? defaultAlignment_1
                            : (_b = (_a = tableCols_1[name].headerAlign) !== null && _a !== void 0 ? _a : tableCols_1[name].dataAlign) !== null && _b !== void 0 ? _b : defaultAlignment_1,
                        dataAlign: (_d = (_c = tableCols_1[name].dataAlign) !== null && _c !== void 0 ? _c : tableCols_1[name].headerAlign) !== null && _d !== void 0 ? _d : defaultAlignment_1,
                        disabledRows: (_e = tableCols_1[name].disabledRows) !== null && _e !== void 0 ? _e : [],
                        tdStyle: (0, tables_1.getCellStyle)(tableCols_1[name].readonly),
                        headerText: (_f = tableCols_1[name]) === null || _f === void 0 ? void 0 : _f["columnTip"],
                    });
                });
    ...
    function MyImportInterfaces(imports, model, config) {
        ...
        this.createProcessedImports = function (stage) {
            ...
            (_a = (0, Utils_1.getKeys)(processedImports !== null && processedImports !== void 0 ? processedImports : {})) === null || _a === void 0 ? void 0 : _a.forEach(function (key) {
                ...
                processedImports = __assign(__assign({}, processedImports), (_a = {}, _a[key] = __assign(__assign({}, processedImports[key]), { args: stage === "arguments"
...
var CreateRegisterView = /** @class */ (function () {
    function CreateRegisterView(module) {
        ...
        this.withEditableRegister = function (register) {
            ...
            if (register) {
                Arrays_1.values((_a = register === null || register === void 0 ? void 0 : register.settings) !== null && _a !== void 0 ? _a : {}).forEach(function (setting) {
    ...
    CreateRegisterView.prototype.getNoOptionsViewSchema = function (setting) {
        ...
        var uiSchemaBuilder = new ViewSchemaBuilder_1.UiSchemaBuilder()
            ...
            .withUiHelp(setting.getName() + ": " + ((_a = setting.getDescription()) !== null && _a !== void 0 ? _a : ""));
        return {
    ...
    CreateRegisterView.prototype.createHasOptionsViewSchema = function (setting) {
        var _a, _b;
        var schemaBuilder = new ViewSchemaBuilder_1.SchemaBuilder("string", (_a = Setting_1.getBitLabel(setting.getSetting())) !== null && _a !== void 0 ? _a : "")
            .withEnum(setting.getOptionNames())
            .withDefault(setting.mapToOptionNameIfExists(setting.getValue()));
        var uiSchemaBuilder = new ViewSchemaBuilder_1.UiSchemaBuilder()
            .withReadonlyValue(setting.getIsReadonly())
            .withUiHelp(setting.getName() + ": " + ((_b = setting.getDescription()) !== null && _b !== void 0 ? _b : ""));
        return {
    ...
    CreateRegisterView.prototype.createSettingViewSchema = function (setting) {
        var _a;
        var schema = new ViewSchemaBuilder_1.SchemaBuilder("integer", (_a = Setting_1.getBitLabel(setting.getSetting())) !== null && _a !== void 0 ? _a : "").withDefault(setting.mapToOptionNameIfExists(setting.getPORDefault()));
...
var RegisterViewModel = /** @class */ (function () {
    ...
    RegisterViewModel.sortSettingsDescending = function (settings) {
        var result = __spreadArrays(settings);
        result.sort(function (settingOne, settingTwo) {
            var _a, _b, _c, _d;
            var bitRangeOne = (_b = (_a = Setting_1.getBitRange(settingOne.getSetting())) === null || _a === void 0 ? void 0 : _a.high) !== null && _b !== void 0 ? _b : -1;
            var bitRangeTwo = (_d = (_c = Setting_1.getBitRange(settingTwo.getSetting())) === null || _c === void 0 ? void 0 : _c.high) !== null && _d !== void 0 ? _d : -1;
...
/***/ "./node_modules/@microchip/uart-basic-drv-interface/lib/package.json":
/*!***************************************************************************!*\
  !*** ./node_modules/@microchip/uart-basic-drv-interface/lib/package.json ***!
  \***************************************************************************/
...
module.exports = JSON.parse("{\"name\":\"@microchip/uart-basic-drv-interface\",\"version\":\"2.3.0\",\"license\":\"SEE LICENSE IN LICENSE.txt\",\"main\":\"lib/src/index.js\",\"typings\":\"./lib/src/index.d.ts\",\"scripts\":{\"build\":\"tsc\",\"test\":\"jest\",\"lint:nofix\":\"eslint \\\"./src/**/*.{ts,tsx}\\\" --quiet\",\"lint\":\"tsc --noEmit && yarn lint:nofix --fix\"},\"husky\":{\"hooks\":{\"pre-commit\":\"tsc --noEmit && lint-staged\"}},\"lint-staged\":{\"./src/**/*.{ts,tsx}\":[\"eslint --fix\"]},\"bitBucketRepository\":\"https://bitbucket.microchip.com/projects/CC16SCRIP/repos/uart-basic-drv-interface/browse\",\"repository\":{\"type\":\"git\",\"url\":\"git+ssh://git@https://bitbucket.microchip.com/scm/cc16scrip/uart-basic-drv-interface.git\"},\"publishConfig\":{\"registry\":\"https://artifacts.microchip.com/artifactory/api/npm/npm/\"},\"jest\":{\"testPathIgnorePatterns\":[\"/node_modules/\",\"/run/\",\"/lib/\"],\"modulePathIgnorePatterns\":[\"<rootDir>/run\"],\"preset\":\"ts-jest\",\"collectCoverage\":true},\"dependencies\":{\"@microchip/scf-common\":\"^3.17.0\",\"@microchip/scf-interface\":\"^1.4.0\",\"@microchip/uart-basic\":\"^6.3.0\"},\"devDependencies\":{\"@types/jest\":\"^24.0.14\",\"@types/node\":\"^12.0.10\",\"@typescript-eslint/eslint-plugin\":\"^2.27.0\",\"@typescript-eslint/parser\":\"^2.27.0\",\"eslint\":\"^6.8.0\",\"eslint-config-prettier\":\"^6.10.1\",\"eslint-plugin-prettier\":\"^3.1.2\",\"husky\":\"^4.2.4\",\"jest\":\"^24.8.0\",\"lint-staged\":\"^10.2.0\",\"prettier\":\"^2.0.4\",\"ts-jest\":\"^24.0.2\",\"typescript\":\"^3.8.3\"},\"files\":[\"lib/**/*\"],\"notificationEmail\":\"1d0dd98b.microchiptechnology.onmicrosoft.com@amer.teams.ms\"}");

/***/ }),

/***/ "./node_modules/@microchip/uart-basic-drv-interface/lib/src/index.js":
/*!***************************************************************************!*\
  !*** ./node_modules/@microchip/uart-basic-drv-interface/lib/src/index.js ***!
  \***************************************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var uart_basic_drv_interface_1 = __webpack_require__(/*! ./uart-basic-drv-interface */ "./node_modules/@microchip/uart-basic-drv-interface/lib/src/uart-basic-drv-interface.js");
Object.defineProperty(exports, "Interface", { enumerable: true, get: function () { return uart_basic_drv_interface_1.Interface; } });
var uart_basic_1 = __webpack_require__(/*! @microchip/uart-basic */ "./node_modules/@microchip/uart-basic/lib/src/index.js");
Object.defineProperty(exports, "getUARTInterfaceApiStructure", { enumerable: true, get: function () { return uart_basic_1.getUARTInterfaceApiStructure; } });
//# sourceMappingURL=index.js.map

/***/ }),

/***/ "./node_modules/@microchip/uart-basic-drv-interface/lib/src/uart-basic-drv-interface.js":
/*!**********************************************************************************************!*\
  !*** ./node_modules/@microchip/uart-basic-drv-interface/lib/src/uart-basic-drv-interface.js ***!
  \**********************************************************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.Interface = exports.getInterfaceId = void 0;
...
var pkgJson = __importStar(__webpack_require__(/*! ../package.json */ "./node_modules/@microchip/uart-basic-drv-interface/lib/package.json"));
var uart_basic = __importStar(__webpack_require__(/*! @microchip/uart-basic */ "./node_modules/@microchip/uart-basic/lib/src/index.js"));
/*Custom Name can be requested at Argument stage by the User of this interface*/
...
var createMock = function () {
    return {
        ...
        payload: {
            ...
            parity: "None",
            stopBits: 1,
            hasParitySupport: true,
            hasStopBitsSupport: true,
            moduleInstance: 1,
            hasInterrupts: true,
            interruptDriven: false,
            hasNonbufferedInterruptSupport: true,
            rxDataBufferSizeOptions: ["8", "16", "32", "64", "128", "256", "512", "1024"],
            txDataBufferSizeOptions: ["8", "16", "32", "64", "128", "256", "512", "1024"],
            rxDataBufferSize: 0,
            txDataBufferSize: 0,
            hasDataBuffer: true,
            ...
            errorCallback: {
                name: "errorHandler",
                header: "header/basic_uart.h",
            },
            framingErrorCallback: {
                name: "framingErrorHandler",
                header: "header/basic_uart.h",
            },
            overrunErrorCallback: {
                name: "overrunErrorHandler",
                header: "header/basic_uart.h",
            },
            parityErrorCallback: {
                name: "parityErrorHandler",
                header: "header/basic_uart.h",
            },
            customName: "UART1",
            redirectToPrintf: false,
            flowControlOptions: ["None"],
            defaultFlowControlMode: "None",
            interfaceStructObjName: "UART1_Drv",
            interfaceApi: uart_basic.getUARTInterfaceApiStructure("UART1"),
        },
        args: {
            requestId: {
                customName: "UART1",
...
//# sourceMappingURL=uart-basic-drv-interface.js.map

/***/ }),

/***/ "./node_modules/@microchip/uart-basic/lib/package.json":
/*!*************************************************************!*\
  !*** ./node_modules/@microchip/uart-basic/lib/package.json ***!
  \*************************************************************/
/*! exports provided: name, version, license, main, typings, scripts, husky, lint-staged, bitBucketRepository, repository, publishConfig, jest, dependencies, devDependencies, files, notificationEmail, default */
...
module.exports = JSON.parse("{\"name\":\"@microchip/uart-basic\",\"version\":\"6.3.0\",\"license\":\"SEE LICENSE IN LICENSE.txt\",\"main\":\"lib/src/index.js\",\"typings\":\"./lib/src/index.d.ts\",\"scripts\":{\"build\":\"tsc\",\"test\":\"jest\",\"lint:nofix\":\"eslint \\\"./src/**/*.{ts,tsx}\\\" --quiet\",\"lint\":\"tsc --noEmit && yarn lint:nofix --fix\"},\"husky\":{\"hooks\":{\"pre-commit\":\"tsc --noEmit && lint-staged\"}},\"lint-staged\":{\"./src/**/*.{ts,tsx}\":[\"eslint --fix\"]},\"bitBucketRepository\":\"https://bitbucket.microchip.com/projects/SCF/repos/uart-basic/browse\",\"repository\":{\"type\":\"git\",\"url\":\"git+ssh://git@https://bitbucket.microchip.com/scm/scf/uart-basic.git\"},\"publishConfig\":{\"registry\":\"https://artifacts.microchip.com/artifactory/api/npm/npm/\"},\"jest\":{\"testPathIgnorePatterns\":[\"/node_modules/\",\"/run/\",\"/lib/\"],\"modulePathIgnorePatterns\":[\"<rootDir>/run\"],\"preset\":\"ts-jest\",\"collectCoverage\":true},\"dependencies\":{\"@microchip/scf-common\":\"^3.5.0\",\"@microchip/scf-interface\":\"^1.4.0\"},\"devDependencies\":{\"@microchip/pin-request-types\":\"1.0.0\",\"@types/jest\":\"^24.0.14\",\"@types/node\":\"^12.0.10\",\"@typescript-eslint/eslint-plugin\":\"^2.27.0\",\"@typescript-eslint/parser\":\"^2.27.0\",\"eslint\":\"^6.8.0\",\"eslint-config-prettier\":\"^6.10.1\",\"eslint-plugin-prettier\":\"^3.1.2\",\"fs-extra\":\"^8.1.0\",\"husky\":\"^4.2.4\",\"jest\":\"^24.8.0\",\"lint-staged\":\"^10.2.0\",\"prettier\":\"^2.0.4\",\"ts-jest\":\"^24.0.2\",\"typescript\":\"^3.8.3\"},\"files\":[\"lib/**/*\"],\"notificationEmail\":\"03234d44.microchip.com@amer.teams.ms\"}");

/***/ }),

/***/ "./node_modules/@microchip/uart-basic/lib/src/api.js":
/*!***********************************************************!*\
  !*** ./node_modules/@microchip/uart-basic/lib/src/api.js ***!
  \***********************************************************/
/*! no static exports found */
...
exports.getUartAPI = function () {
    return {
        ...
        TxCollisionCallbackRegister: {
            name: "TxCollisionCallbackRegister",
            returns: "void",
            arguments: [
                {
                    name: "CallbackHandler",
        ...
        FramingErrorCallbackRegister: {
            name: "FramingErrorCallbackRegister",
            returns: "void",
            arguments: [
                {
                    name: "CallbackHandler",
        ...
        OverrunErrorCallbackRegister: {
            name: "OverrunErrorCallbackRegister",
            returns: "void",
            arguments: [
                {
                    name: "CallbackHandler",
        ...
        ParityErrorCallbackRegister: {
            name: "ParityErrorCallbackRegister",
            returns: "void",
            arguments: [
                {
                    name: "CallbackHandler",
...
exports.getUARTHeaderFileData = function (moduleName) {
    return [
        {
            name: moduleName.toLowerCase() + ".h",
            path: "mcc_generated_files/uart/",
        },
        { name: "uart_interface" + ".h", path: "mcc_generated_files/uart/" },
        { name: "uart_types" + ".h", path: "mcc_generated_files/uart/" },
    ];
};
...
/***/ "./node_modules/@microchip/uart-basic/lib/src/index.js":
/*!*************************************************************!*\
  !*** ./node_modules/@microchip/uart-basic/lib/src/index.js ***!
  \*************************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var uart_basic_1 = __webpack_require__(/*! ./uart-basic */ "./node_modules/@microchip/uart-basic/lib/src/uart-basic.js");
exports.Interface = uart_basic_1.Interface;
exports.getUARTInterfaceApiStructure = uart_basic_1.getUARTInterfaceApiStructure;
//# sourceMappingURL=index.js.map

/***/ }),

/***/ "./node_modules/@microchip/uart-basic/lib/src/uart-basic.js":
/*!******************************************************************!*\
  !*** ./node_modules/@microchip/uart-basic/lib/src/uart-basic.js ***!
  \******************************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var InterfaceTypes = __importStar(__webpack_require__(/*! @microchip/scf-interface */ "./node_modules/@microchip/scf-interface/lib/index.js"));
var pkgJson = __importStar(__webpack_require__(/*! ../package.json */ "./node_modules/@microchip/uart-basic/lib/package.json"));
var api_1 = __webpack_require__(/*! ./api */ "./node_modules/@microchip/uart-basic/lib/src/api.js");
exports.getUARTInterfaceApiStructure = function (moduleName) {
    return {
        api: api_1.getUartAPI(),
        headerFiles: api_1.getUARTHeaderFileData(moduleName),
    };
};
...
var createMock = function () {
    return {
        ...
        payload: {
            ...
            defaultFlowControlMode: "None",
            interfaceStructObjName: "UART1_DRV",
            interfaceApi: exports.getUARTInterfaceApiStructure("UART1"),
            hasNonbufferedInterruptSupport: false,
            interruptMode: "Non-buffered",
        },
        args: {
            requestId: {
                baudrate: 9600,
...
//# sourceMappingURL=uart-basic.js.map
...
/* harmony import */ var _microchip_uart_basic__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @microchip/uart-basic */ "./node_modules/@microchip/uart-basic/lib/src/index.js");
/* harmony import */ var _microchip_uart_basic__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_microchip_uart_basic__WEBPACK_IMPORTED_MODULE_0__);
...
var getCreatorImportArgs = function getCreatorImportArgs(interfaceName, state) {
  var _uart_basic$Interface, _uart_basic$Interface2;

  var importArgs;

  if (_microchip_uart_basic__WEBPACK_IMPORTED_MODULE_0__ && interfaceName === (_microchip_uart_basic__WEBPACK_IMPORTED_MODULE_0__ === null || _microchip_uart_basic__WEBPACK_IMPORTED_MODULE_0__ === void 0 ? void 0 : (_uart_basic$Interface = _microchip_uart_basic__WEBPACK_IMPORTED_MODULE_0__["Interface"]) === null || _uart_basic$Interface === void 0 ? void 0 : (_uart_basic$Interface2 = _uart_basic$Interface.getInterfaceId()) === null || _uart_basic$Interface2 === void 0 ? void 0 : _uart_basic$Interface2.name)) {
    var _uart_basic$Interface3, _uart_basic$Interface4, _uart_basic$Interface5;

    var args = (_uart_basic$Interface3 = _microchip_uart_basic__WEBPACK_IMPORTED_MODULE_0__["Interface"]) === null || _uart_basic$Interface3 === void 0 ? void 0 : (_uart_basic$Interface4 = _uart_basic$Interface3.createMock()) === null || _uart_basic$Interface4 === void 0 ? void 0 : (_uart_basic$Interface5 = _uart_basic$Interface4.args) === null || _uart_basic$Interface5 === void 0 ? void 0 : _uart_basic$Interface5.requestId;

    if (args && state && state.main && state.main.software) {
      if (state.main.software.baudrate) {
        args.baudrate = state.main.software.baudrate;
      }

      if (state.main.software.parity) {
        args.parity = state.main.software.parity;
      } //converting it to number since the interface has type "number"


      if (state.main.software.dataSize) {
        args.dataSize = Number(state.main.software.dataSize);
      }

      if (state.main.software.stopBits) {
        args.stopBits = Number(state.main.software.stopBits);
      }
    }

    if (args && state && state.main && state.main.interrupt) {
      if (state.main.interrupt.interruptDriven) {
        args.interruptDriven = state.main.interrupt.interruptDriven;
      }

      if (state.main.interrupt.txDataBufferSize) {
        args.txDataBufferSize = Number(state.main.interrupt.txDataBufferSize);
      }

      if (state.main.interrupt.rxDataBufferSize) {
        args.rxDataBufferSize = Number(state.main.interrupt.rxDataBufferSize);
      }
    }
...
/* harmony import */ var _microchip_uart_basic_drv_interface__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @microchip/uart-basic-drv-interface */ "./node_modules/@microchip/uart-basic-drv-interface/lib/src/index.js");
/* harmony import */ var _microchip_uart_basic_drv_interface__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_microchip_uart_basic_drv_interface__WEBPACK_IMPORTED_MODULE_0__);
...
var UART_DRV_INTF_NAME = "uart-basic-drv-interface";
var CUSTOM_NAME_COMPONENT = "customName";
var BAUDRATE_COMPONENT = "baudrate";
var PARITY_COMPONENT = "parity";
var DATA_SIZE_COMPONENT = "dataSize";
var STOP_BIT_COMPONENT = "stopBits";
var INTERRUPT_COMPONENT = "interruptDriven";
var INTERRUPT_MODE = "interruptMode";
var TRANSMIT_DATA_BUFFER_SIZE_COMPONENT = "txDataBufferSize";
var RECEIVE_DATA_BUFFER_SIZE_COMPONENT = "rxDataBufferSize";
var REDIRECTPRINTF_COMPONENT = "redirectPrintf";
var FLOW_CONTROL_MODE_COMPONENT = "flowControlMode";
var BUFFERED = "Buffered";
var NON_BUFFERED = "Non-buffered";
var BAUD_RATE_ERROR = "baudRateError";
...
var MyDerivedData = /*#__PURE__*/_createClass(function MyDerivedData(dataModel) {
  ...
  _defineProperty(this, "getMyFunctions", function () {
    return {
      ...
      baudRateError: _this.getBaudRateError,
      templateData: _this.getMyTemplateData,
      alerts: _this.getMyAlerts,
      actualBaudrate: _this.getActualBaudrate,
      isActualBaudrateVisible: _this.isActualBaudrateVisible,
      uart_basic_args: _this.getBasicUartArgs,
      uart_basic_results: _this.getBasicUartResults,
      ...
      isBufferEnableVisible: _this.isBufferEnableVisible,
      isInterruptBufferVisible: _this.isInterruptBufferVisible,
      "uart-basic-drv-interface_payload": _this.getUartBasicDrvPayload,
      overrideModuleLevelHelp: _this.overrideModuleLevelHelp
    };
  });

  _defineProperty(this, "isInterruptBufferVisible", function () {
    if (_this.isInterruptEnabled()) {
      var processedPayloadVal = _this.dataModel.getImportValue("uart_basic");

      if (processedPayloadVal !== null && processedPayloadVal !== void 0 && processedPayloadVal.hasNonbufferedInterruptSupport) {
        return _this.dataModel.getComponentValue(INTERRUPT_MODE) ? true : false;
      } else return true;
    }
  ...
  _defineProperty(this, "isBufferEnableVisible", function () {
    var processedPayloadVal = _this.dataModel.getImportValue("uart_basic");

    if (processedPayloadVal !== null && processedPayloadVal !== void 0 && processedPayloadVal.hasNonbufferedInterruptSupport) {
      return _this.isInterruptEnabled();
    }

    return false;
  });

  _defineProperty(this, "interruptMode", function () {
    return _this.dataModel.getComponentValue(INTERRUPT_MODE) ? BUFFERED : NON_BUFFERED;
  });
  ...
  _defineProperty(this, "overrideModuleLevelHelp", function () {
    ...
    if (deviceName === "PIC16" || deviceName === "PIC18") {
      ...
      url = "v2/keyword-lookup?keyword=UART_33A_MELODY_DRIVER&version=latest&redirect=true";
      tooltip = "Click here to open UART API documentation";
    } else if (deviceName === undefined) {
      url = "";
      tooltip = "Load UART Driver to view help.";
    } else {
      url = "v2/keyword-lookup?keyword=UART_MELODY_DRIVER&version=latest&redirect=true";
  ...
  _defineProperty(this, "getUiBehavior", function (component) {
    var uiBehavior = {};
    var printfHelp = "Ensure Redirect to Printf is enabled for only one UART driver.";

    if (_this.getRequestedArg(component, UART_DRV_INTF_NAME)) {
      switch (component) {
        ...
        case FLOW_CONTROL_MODE_COMPONENT:
          uiBehavior = _defineProperty({}, "ui:help", _this.getUiBehaviorStrField(component));
          break;

        case INTERRUPT_COMPONENT:
          {
            uiBehavior = _defineProperty({}, "ui:help", _this.getUiBehaviorBooleanField(component));
            break;
          }

        case INTERRUPT_MODE:
          {
            uiBehavior = _defineProperty({}, "ui:help", _this.getUiBehaviorInterruptModeField(component));
            break;
          }

        case REDIRECTPRINTF_COMPONENT:
          {
            uiBehavior = _defineProperty({}, "ui:help", _this.getUiBehaviorStrField(component) + "." + printfHelp);
            break;
          }
      ...
      switch (component) {
        case REDIRECTPRINTF_COMPONENT:
          uiBehavior = _defineProperty({}, "ui:help", printfHelp);
          break;

        case BAUD_RATE_ERROR:
          {
            if (_this.isBaudRateErrorOverLimit(component)) {
              uiBehavior = _defineProperty({}, "mvl:customErrorMsg", "Baud rate error exceeds 2.2%, modify the UART clock through 'System -> Clock' or within the UART PLIB");
            }
  ...
  _defineProperty(this, "getUiBehaviorInterruptModeField", function (component) {
    var _this$getRequestedArg;

    var reqField = (_this$getRequestedArg = _this.getRequestedArg(component, UART_DRV_INTF_NAME)) === null || _this$getRequestedArg === void 0 ? void 0 : _this$getRequestedArg.value;
    var setField = _this.dataModel.getComponentValue(component) ? BUFFERED : NON_BUFFERED;

    if (reqField != undefined && setField != undefined && reqField != setField) {
      var strType = "Enable";
      if (reqField == "Non-buffered") strType = "Disable";
      return strType + " field to" + " match with value requested by dependent module";
    }

    return "Field is being set by dependent module, any updates will override preconfigured value";
  });

  _defineProperty(this, "getUiBehaviorStrField", function (component) {
    var _this$getRequestedArg2;

    var reqField = (_this$getRequestedArg2 = _this.getRequestedArg(component, UART_DRV_INTF_NAME)) === null || _this$getRequestedArg2 === void 0 ? void 0 : _this$getRequestedArg2.value;

    var setField = _this.dataModel.getComponentValue(component);

    if (reqField != undefined && setField != undefined && reqField != setField) {
      return "Configure field to " + reqField + " to match with value requested by dependent module";
    }

    return "Field is being set by dependent module, any updates will override preconfigured value";
  });

  _defineProperty(this, "getUiBehaviorBooleanField", function (component) {
    var _this$getRequestedArg3;

    var reqField = (_this$getRequestedArg3 = _this.getRequestedArg(component, UART_DRV_INTF_NAME)) === null || _this$getRequestedArg3 === void 0 ? void 0 : _this$getRequestedArg3.value;
  ...
  _defineProperty(this, "isBaudRateErrorOverLimit", function (componentName) {
    var isImportAssigned = _this.dataModel.getImportValue("uart_basic");

    var BaudRateErrorPercentage = _this.dataModel.getComponentValue(componentName);
  ...
  _defineProperty(this, "getRequestedArg", function (componentName, interfaceName) {
    var _this$dataModel;

    var exportData = (_this$dataModel = _this.dataModel) === null || _this$dataModel === void 0 ? void 0 : _this$dataModel.getExportInterfaces().getInterfaceData();

    if (exportData != undefined) {
      for (var i = 0; i < exportData.length; i++) {
        if (exportData[i]["interface"] === interfaceName && exportData[i].name === componentName) {
          return exportData[i];
        }
      }
    }
  ...
  _defineProperty(this, "getUartBasicDrvPayload", function () {
    var interfaceData = _this.dataModel.getImportValue("uart_basic");

    if (interfaceData != undefined) {
      var _this$dataModel$getCo, _this$dataModel2, _this$dataModel$getCo2, _this$dataModel3;

      var interfaceStructObjName = (_this$dataModel$getCo = (_this$dataModel2 = _this.dataModel) === null || _this$dataModel2 === void 0 ? void 0 : _this$dataModel2.getComponentValue("customName")) !== null && _this$dataModel$getCo !== void 0 ? _this$dataModel$getCo : "";

      if (interfaceStructObjName == interfaceData.moduleName) {
        interfaceStructObjName = interfaceData.interfaceStructObjName;
      }

      return _objectSpread(_objectSpread({}, interfaceData), {}, {
        customName: (_this$dataModel$getCo2 = (_this$dataModel3 = _this.dataModel) === null || _this$dataModel3 === void 0 ? void 0 : _this$dataModel3.getComponentValue("customName")) !== null && _this$dataModel$getCo2 !== void 0 ? _this$dataModel$getCo2 : "",
        interfaceStructObjName: interfaceStructObjName
      });
    }
  });

  _defineProperty(this, "isEnabled", function (componentName) {
    var processedPayloadVal = _this.dataModel.getImportValue("uart_basic");
    ...
    switch (componentName) {
      case "parity":
        if ((processedPayloadVal === null || processedPayloadVal === void 0 ? void 0 : processedPayloadVal.hasParitySupport) === undefined || processedPayloadVal !== null && processedPayloadVal !== void 0 && processedPayloadVal.hasParitySupport) {
          enableStatus = true;
        } else {
          enableStatus = false;
        }
      ...
      case "stopBits":
        if ((processedPayloadVal === null || processedPayloadVal === void 0 ? void 0 : processedPayloadVal.hasStopBitsSupport) === undefined || processedPayloadVal !== null && processedPayloadVal !== void 0 && processedPayloadVal.hasStopBitsSupport) {
          enableStatus = true;
        } else {
          enableStatus = false;
        }
  ...
  _defineProperty(this, "isInterruptEnabled", function () {
    var _this$dataModel$getCo3;

    return (_this$dataModel$getCo3 = _this.dataModel.getComponentValue(INTERRUPT_COMPONENT)) !== null && _this$dataModel$getCo3 !== void 0 ? _this$dataModel$getCo3 : false;
  });
  ...
  _defineProperty(this, "getActiveName", function () {
    ...
    if ((processedPayloadVal === null || processedPayloadVal === void 0 ? void 0 : processedPayloadVal.moduleInstance) != undefined) {
      var _this$dataModel$getCo4, _this$dataModel4;

      return (_this$dataModel$getCo4 = (_this$dataModel4 = _this.dataModel) === null || _this$dataModel4 === void 0 ? void 0 : _this$dataModel4.getComponentValue("customName")) !== null && _this$dataModel$getCo4 !== void 0 ? _this$dataModel$getCo4 : "";
    }

    return ((_this$dataModel5 = _this.dataModel) === null || _this$dataModel5 === void 0 ? void 0 : _this$dataModel5.getComponentValue("customName")) + "(None)";
  });

  _defineProperty(this, "getBasicUartResults", function () {
    var _this$dataModel6, _this$dataModel7;

    return {
      customName: (_this$dataModel6 = _this.dataModel) === null || _this$dataModel6 === void 0 ? void 0 : _this$dataModel6.getComponentValue("customName"),
      flowControlMode: (_this$dataModel7 = _this.dataModel) === null || _this$dataModel7 === void 0 ? void 0 : _this$dataModel7.getComponentValue("flowControlMode"),
      plibRequests: _this.getPlibRequestsFromUartDrvIntf()
    };
  });

  _defineProperty(this, "getPlibRequestsFromUartDrvIntf", function () {
    var _this$dataModel8, _this$dataModel8$getE, _this$dataModel8$getE2;

    var resultsMap = (_this$dataModel8 = _this.dataModel) === null || _this$dataModel8 === void 0 ? void 0 : (_this$dataModel8$getE = _this$dataModel8.getExportInterfaces()) === null || _this$dataModel8$getE === void 0 ? void 0 : (_this$dataModel8$getE2 = _this$dataModel8$getE.getInterface("uart_basic_drv_interface", _microchip_uart_basic_drv_interface__WEBPACK_IMPORTED_MODULE_0__["Interface"].getInterfaceId())) === null || _this$dataModel8$getE2 === void 0 ? void 0 : _this$dataModel8$getE2.results;

    if (resultsMap != undefined) {
      for (var moduleId in resultsMap) {
        var _resultsMap$moduleId;

        var plibRequest = (_resultsMap$moduleId = resultsMap[moduleId]) === null || _resultsMap$moduleId === void 0 ? void 0 : _resultsMap$moduleId.plibRequests;
  ...
  _defineProperty(this, "filterMyImports", function (imports) {
    var _filteredImports$uart;

    var filteredImports = _this.dataModel.filterImportBySetting(imports, "uart_basic", function (option) {
      return true;
    });

    if (filteredImports !== null && filteredImports !== void 0 && (_filteredImports$uart = filteredImports.uart_basic) !== null && _filteredImports$uart !== void 0 && _filteredImports$uart.options) {
      filteredImports.uart_basic.options.sort(function (importOption1, importOption2) {
        var _importOption1$payloa, _importOption1$payloa2, _importOption2$payloa, _importOption2$payloa2;

        return ((_importOption1$payloa = (_importOption1$payloa2 = importOption1.payload) === null || _importOption1$payloa2 === void 0 ? void 0 : _importOption1$payloa2.moduleInstance) !== null && _importOption1$payloa !== void 0 ? _importOption1$payloa : 0) > ((_importOption2$payloa = (_importOption2$payloa2 = importOption2.payload) === null || _importOption2$payloa2 === void 0 ? void 0 : _importOption2$payloa2.moduleInstance) !== null && _importOption2$payloa !== void 0 ? _importOption2$payloa : 0) ? 1 : -1;
      });
    }
  ...
  _defineProperty(this, "overrideDefaultValue", function (componentName) {
    var _this$getRequestedArg5, _this$getRequestedArg6, _this$getRequestedArg7, _this$getRequestedArg8, _this$getRequestedArg9, _this$getRequestedArg10, _this$getRequestedArg11, _this$getRequestedArg13, _this$getRequestedArg14, _this$getRequestedArg15, _this$getRequestedArg16, _this$getRequestedArg17;

    switch (componentName) {
      case CUSTOM_NAME_COMPONENT:
        {
          var _this$getRequestedArg4;

          var customName = (_this$getRequestedArg4 = _this.getRequestedArg("customName", UART_DRV_INTF_NAME)) === null || _this$getRequestedArg4 === void 0 ? void 0 : _this$getRequestedArg4.value;
      ...
      case BAUDRATE_COMPONENT:
        return (_this$getRequestedArg5 = _this.getRequestedArg("baudrate", UART_DRV_INTF_NAME)) === null || _this$getRequestedArg5 === void 0 ? void 0 : _this$getRequestedArg5.value;

      case PARITY_COMPONENT:
        return (_this$getRequestedArg6 = _this.getRequestedArg("parity", UART_DRV_INTF_NAME)) === null || _this$getRequestedArg6 === void 0 ? void 0 : _this$getRequestedArg6.value;

      case DATA_SIZE_COMPONENT:
        return (_this$getRequestedArg7 = _this.getRequestedArg("dataSize", UART_DRV_INTF_NAME)) === null || _this$getRequestedArg7 === void 0 ? void 0 : (_this$getRequestedArg8 = _this$getRequestedArg7.value) === null || _this$getRequestedArg8 === void 0 ? void 0 : _this$getRequestedArg8.toString();

      case STOP_BIT_COMPONENT:
        return (_this$getRequestedArg9 = _this.getRequestedArg("stopBits", UART_DRV_INTF_NAME)) === null || _this$getRequestedArg9 === void 0 ? void 0 : (_this$getRequestedArg10 = _this$getRequestedArg9.value) === null || _this$getRequestedArg10 === void 0 ? void 0 : _this$getRequestedArg10.toString();

      case INTERRUPT_COMPONENT:
        return (_this$getRequestedArg11 = _this.getRequestedArg("interruptDriven", UART_DRV_INTF_NAME)) === null || _this$getRequestedArg11 === void 0 ? void 0 : _this$getRequestedArg11.value;

      case INTERRUPT_MODE:
        {
          var _this$getRequestedArg12;

          var bufferStatus = (_this$getRequestedArg12 = _this.getRequestedArg(INTERRUPT_MODE, UART_DRV_INTF_NAME)) === null || _this$getRequestedArg12 === void 0 ? void 0 : _this$getRequestedArg12.value;
      ...
      case TRANSMIT_DATA_BUFFER_SIZE_COMPONENT:
        return (_this$getRequestedArg13 = _this.getRequestedArg("txDataBufferSize", UART_DRV_INTF_NAME)) === null || _this$getRequestedArg13 === void 0 ? void 0 : (_this$getRequestedArg14 = _this$getRequestedArg13.value) === null || _this$getRequestedArg14 === void 0 ? void 0 : _this$getRequestedArg14.toString();

      case RECEIVE_DATA_BUFFER_SIZE_COMPONENT:
        return (_this$getRequestedArg15 = _this.getRequestedArg("rxDataBufferSize", UART_DRV_INTF_NAME)) === null || _this$getRequestedArg15 === void 0 ? void 0 : (_this$getRequestedArg16 = _this$getRequestedArg15.value) === null || _this$getRequestedArg16 === void 0 ? void 0 : _this$getRequestedArg16.toString();

      case REDIRECTPRINTF_COMPONENT:
        return (_this$getRequestedArg17 = _this.getRequestedArg("redirectPrintf", UART_DRV_INTF_NAME)) === null || _this$getRequestedArg17 === void 0 ? void 0 : _this$getRequestedArg17.value;

      case FLOW_CONTROL_MODE_COMPONENT:
        {
          var _this$getRequestedArg18;

          var flowControlMode = (_this$getRequestedArg18 = _this.getRequestedArg("flowControlMode", UART_DRV_INTF_NAME)) === null || _this$getRequestedArg18 === void 0 ? void 0 : _this$getRequestedArg18.value;

          if (flowControlMode == undefined) {
            var _processedPayloadVal = _this.dataModel.getImportValue("uart_basic");

            if ((_processedPayloadVal === null || _processedPayloadVal === void 0 ? void 0 : _processedPayloadVal.defaultFlowControlMode) != undefined) {
              return _processedPayloadVal.defaultFlowControlMode;
            }
          }
        }
        break;
  ...
  _defineProperty(this, "overrideOptions", function (componentName) {
    if (componentName === "flowControlMode") {
      ...
      var _processedPayloadVal2 = _this.dataModel.getImportValue("uart_basic");

      if ((_processedPayloadVal2 === null || _processedPayloadVal2 === void 0 ? void 0 : _processedPayloadVal2.txDataBufferSizeOptions) != undefined) {
        return _processedPayloadVal2.txDataBufferSizeOptions;
      }
    } else if (componentName === "rxDataBufferSize") {
      var _processedPayloadVal3 = _this.dataModel.getImportValue("uart_basic");

      if ((_processedPayloadVal3 === null || _processedPayloadVal3 === void 0 ? void 0 : _processedPayloadVal3.rxDataBufferSizeOptions) != undefined) {
        return _processedPayloadVal3.rxDataBufferSizeOptions;
      }
    }
  ...
  _defineProperty(this, "friendlyImportOptionLabels", function (importKey, option) {
    ...
    if (importKey === "uart_basic" && option !== null && option !== void 0 && (_option$payload = option.payload) !== null && _option$payload !== void 0 && _option$payload.moduleInstance) {
  ...
  _defineProperty(this, "getModuleName", function () {
    var _this$dataModel$getCo5, _this$dataModel10;
    ...
    if ((processedPayloadVal === null || processedPayloadVal === void 0 ? void 0 : processedPayloadVal.moduleInstance) != undefined) {
      ...
      return ((_this$dataModel9 = _this.dataModel) === null || _this$dataModel9 === void 0 ? void 0 : _this$dataModel9.getComponentValue("customName")) + " (UART" + processedPayloadVal.moduleInstance + ")";
    }

    return (_this$dataModel$getCo5 = (_this$dataModel10 = _this.dataModel) === null || _this$dataModel10 === void 0 ? void 0 : _this$dataModel10.getComponentValue("customName")) !== null && _this$dataModel$getCo5 !== void 0 ? _this$dataModel$getCo5 : "";
  });
  ...
  _defineProperty(this, "getBaudRateError", function () {
    var _this$dataModel$getCo6, _interfaceData$actual;

    var request = (_this$dataModel$getCo6 = _this.dataModel.getComponentValue("baudrate")) !== null && _this$dataModel$getCo6 !== void 0 ? _this$dataModel$getCo6 : 0;

    var interfaceData = _this.dataModel.getImportValue("uart_basic");

    var actual = (_interfaceData$actual = interfaceData === null || interfaceData === void 0 ? void 0 : interfaceData.actualBaudrate) !== null && _interfaceData$actual !== void 0 ? _interfaceData$actual : 0;
    var baudError = Number((Math.abs(request - actual) / request * 100).toFixed(3));
    return baudError;
  });

  _defineProperty(this, "getActualBaudrate", function () {
    var _Number;

    var interfaceData = _this.dataModel.getImportValue("uart_basic");

    return (_Number = Number(Number(interfaceData === null || interfaceData === void 0 ? void 0 : interfaceData.actualBaudrate).toFixed())) !== null && _Number !== void 0 ? _Number : 0;
  });

  _defineProperty(this, "isActualBaudrateVisible", function () {
    var interfaceData = _this.dataModel.getImportValue("uart_basic");

    if ((interfaceData === null || interfaceData === void 0 ? void 0 : interfaceData.actualBaudrate) != undefined) {
      return true;
    }
  ...
  _defineProperty(this, "getInterruptBufferModeStatus", function () {
    if (_this.dataModel.getComponentValue(INTERRUPT_MODE) != undefined) {
      return _this.dataModel.getComponentValue(INTERRUPT_MODE) ? true : false;
    }
  ...
  _defineProperty(this, "getBasicUartArgs", function () {
    var _Number2, _Number3, _this$getRequestedArg19, _this$getRequestedArg20, _this$getRequestedArg21, _this$getRequestedArg22, _this$getRequestedArg23, _this$getRequestedArg24;

    var interruptDriven = _this.isInterruptEnabled();

    return {
      baudrate: _this.dataModel.getComponentValue("baudrate"),
      parity: _this.dataModel.getComponentValue("parity"),
      dataSize: (_Number2 = Number(_this.dataModel.getComponentValue("dataSize"))) !== null && _Number2 !== void 0 ? _Number2 : 0,
      stopBits: (_Number3 = Number(_this.dataModel.getComponentValue("stopBits"))) !== null && _Number3 !== void 0 ? _Number3 : 0,
      redirectToPrintf: _this.dataModel.getComponentValue("redirectPrintf"),
      rxCompleteCallback: (_this$getRequestedArg19 = _this.getRequestedArg("rxCompleteCallback", UART_DRV_INTF_NAME)) === null || _this$getRequestedArg19 === void 0 ? void 0 : _this$getRequestedArg19.value,
      txCompleteCallback: (_this$getRequestedArg20 = _this.getRequestedArg("txCompleteCallback", UART_DRV_INTF_NAME)) === null || _this$getRequestedArg20 === void 0 ? void 0 : _this$getRequestedArg20.value,
      //Interrupt Extension
      interruptDriven: interruptDriven,
      interruptMode: interruptDriven ? _this.interruptMode() : undefined,
      rxDataBufferSize: interruptDriven && _this.getInterruptBufferModeStatus() ? Number(_this.dataModel.getComponentValue(RECEIVE_DATA_BUFFER_SIZE_COMPONENT)) : undefined,
      txDataBufferSize: interruptDriven && _this.getInterruptBufferModeStatus() ? Number(_this.dataModel.getComponentValue(TRANSMIT_DATA_BUFFER_SIZE_COMPONENT)) : undefined,
      //Error Handling Extension
      errorCallback: (_this$getRequestedArg21 = _this.getRequestedArg("errorCallback", UART_DRV_INTF_NAME)) === null || _this$getRequestedArg21 === void 0 ? void 0 : _this$getRequestedArg21.value,
      framingErrorCallback: (_this$getRequestedArg22 = _this.getRequestedArg("framingErrorCallback", UART_DRV_INTF_NAME)) === null || _this$getRequestedArg22 === void 0 ? void 0 : _this$getRequestedArg22.value,
      overrunErrorCallback: (_this$getRequestedArg23 = _this.getRequestedArg("overrunErrorCallback", UART_DRV_INTF_NAME)) === null || _this$getRequestedArg23 === void 0 ? void 0 : _this$getRequestedArg23.value,
      parityErrorCallback: (_this$getRequestedArg24 = _this.getRequestedArg("parityErrorCallback", UART_DRV_INTF_NAME)) === null || _this$getRequestedArg24 === void 0 ? void 0 : _this$getRequestedArg24.value
    };
  });
...
/*!*******************************!*\
  !*** ./src/moduleConfig.json ***!
  \*******************************/
/*! exports provided: moduleName, deviceType, booleanValues, help, UIGroups, UIOrder, tabs, displayViewOnImportAssigned, imports, exports, softwareData, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"moduleName\":\"UART Configuration\",\"deviceType\":\"PIC\",\"booleanValues\":{\"true\":\"enabled\",\"false\":\"disabled\"},\"help\":{\"url\":\"v2/keyword-lookup?keyword=UART_MELODY_DRIVER&version=latest&redirect=true\",\"tooltip\":\"Click here to open documentation\"},\"UIGroups\":{\"software\":\"Configuration Settings\",\"interrupt\":\"Interrupt Settings\",\"dependency\":\"Dependency Selector\"},\"UIOrder\":{\"software\":[\"customName\",\"*\"],\"errorHandling\":[\"*\"],\"interrupt\":[\"*\"]},\"tabs\":{\"main\":\"Easy View\"},\"displayViewOnImportAssigned\":[\"uart_basic\"],\"imports\":{\"uart_basic\":{\"nodeModule\":{\"importName\":\"uart_basic\",\"node\":\"@microchip/uart-basic\"},\"fullyTyped\":true,\"import\":{\"interfaceId\":{\"name\":\"uart-basic\",\"version\":\"^6.0.0\"}}},\"device_meta\":{\"import\":{\"interfaceId\":{\"name\":\"device-meta\",\"version\":\"^1.0.0\"}}}},\"exports\":{\"uart_basic_drv_interface\":{\"interfaces\":[{\"interfaceId\":{\"name\":\"uart-basic-drv-interface\",\"version\":\"2.3.0\"}}],\"handleLimit\":1}},\"softwareData\":{\"customName\":{\"name\":\"customName\",\"description\":\"Custom Name\",\"type\":\"string\",\"defaultValue\":\"UART\",\"group\":\"software\",\"tabs\":[\"main\"],\"validation\":true,\"category\":\"software\"},\"baudrate\":{\"name\":\"baudrate\",\"description\":\"Requested Baudrate\",\"type\":\"number\",\"defaultValue\":9600,\"group\":\"software\",\"tabs\":[\"main\"],\"category\":\"software\"},\"actualBaudrate\":{\"name\":\"actualBaudrate\",\"description\":\"Calculated Baudrate\",\"type\":\"number\",\"defaultValue\":0,\"group\":\"software\",\"tabs\":[\"main\"],\"derivedValue\":true,\"uiBehavior\":{\"readonly\":true},\"isVisibleProperty\":\"isActualBaudrateVisible\",\"category\":\"software\"},\"baudRateError\":{\"name\":\"baudRateError\",\"description\":\"Baud Rate Error (%)\",\"type\":\"number\",\"defaultValue\":0,\"group\":\"software\",\"uiBehavior\":{\"readonly\":true},\"derivedValue\":true,\"tabs\":[\"main\"],\"category\":\"software\"},\"parity\":{\"name\":\"parity\",\"description\":\"Parity\",\"type\":\"ComboBox\",\"defaultValue\":{\"value\":\"None\",\"options\":[\"None\",\"Even\",\"Odd\"]},\"group\":\"software\",\"tabs\":[\"main\"],\"category\":\"software\"},\"dataSize\":{\"name\":\"dataSize\",\"description\":\"Data Size\",\"type\":\"ComboBox\",\"defaultValue\":{\"value\":\"8\",\"options\":[\"8\",\"9\"]},\"group\":\"software\",\"tabs\":[\"main\"],\"category\":\"software\"},\"stopBits\":{\"name\":\"stopBits\",\"description\":\"Stop Bits\",\"type\":\"ComboBox\",\"defaultValue\":{\"value\":\"1\",\"options\":[\"1\",\"2\"]},\"group\":\"software\",\"tabs\":[\"main\"],\"category\":\"software\"},\"flowControlMode\":{\"name\":\"flowControlMode\",\"description\":\"Flow Control Mode\",\"type\":\"ComboBox\",\"defaultValue\":{\"value\":\"\",\"options\":[]},\"group\":\"software\",\"tabs\":[\"main\"],\"category\":\"software\"},\"redirectPrintf\":{\"name\":\"redirectPrintf\",\"description\":\"Redirect Printf to UART\",\"type\":\"boolean\",\"defaultValue\":false,\"group\":\"software\",\"tabs\":[\"main\"],\"category\":\"software\"},\"interruptDriven\":{\"name\":\"interruptDriven\",\"description\":\"Interrupt Driven\",\"type\":\"boolean\",\"defaultValue\":false,\"group\":\"interrupt\",\"tabs\":[\"main\"],\"category\":\"software\"},\"interruptMode\":{\"name\":\"interruptMode\",\"description\":\"Software Buffer Enable\",\"type\":\"boolean\",\"defaultValue\":true,\"group\":\"interrupt\",\"tabs\":[\"main\"],\"isVisibleProperty\":\"isBufferEnableVisible\",\"category\":\"software\"},\"txDataBufferSize\":{\"name\":\"txDataBufferSize\",\"description\":\"Software Transmit Buffer Size\",\"type\":\"ComboBox\",\"defaultValue\":{\"value\":\"8\",\"options\":[\"8\",\"16\",\"32\",\"64\",\"128\",\"256\"]},\"group\":\"interrupt\",\"tabs\":[\"main\"],\"mode\":{\"masterComponent\":\"interruptDriven\",\"operation\":\"isVisible\",\"matchRegEx\":\"true\"},\"isVisibleProperty\":\"isInterruptBufferVisible\",\"category\":\"software\"},\"rxDataBufferSize\":{\"name\":\"rxDataBufferSize\",\"description\":\"Software Receive Buffer Size\",\"type\":\"ComboBox\",\"defaultValue\":{\"value\":\"8\",\"options\":[\"8\",\"16\",\"32\",\"64\",\"128\",\"256\"]},\"group\":\"interrupt\",\"tabs\":[\"main\"],\"mode\":{\"masterComponent\":\"interruptDriven\",\"operation\":\"isVisible\",\"matchRegEx\":\"true\"},\"isVisibleProperty\":\"isInterruptBufferVisible\",\"category\":\"software\"},\"depSelector\":{\"name\":\"depSelector\",\"category\":\"import\",\"description\":\"UART PLIB Selector\",\"type\":\"ComboBox\",\"group\":\"dependency\",\"importId\":\"uart_basic\",\"tabs\":[\"main\"]}}}");
