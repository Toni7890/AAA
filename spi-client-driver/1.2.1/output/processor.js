...
var MyAppModel = /** @class */ (function () {
    function MyAppModel(prototype, getDerivedData) {
        ...
        this.getImportInterfaces = function () {
            console.log("alallalala " + JSON.stringify(_this.prototype));
    ...
    if (config) {
        ...
        (_a = (0, Utils_1.getKeys)(components_1)) === null || _a === void 0 ? void 0 : _a.forEach(function (eachKey) {
            ...
            if (component.category === "file_save") {
                ...
                schema["fileSaveProps"]["fileName"] = (_e = component.fileMeta) === null || _e === void 0 ? void 0 : _e.defaultName;
                schema["fileSaveProps"]["type"] = "file_save";
            }
            if (component.category === "table") {
                var tableState = (_h = (_g = (_f = model === null || model === void 0 ? void 0 : model.getState()) === null || _f === void 0 ? void 0 : _f[tab]) === null || _g === void 0 ? void 0 : _g[group]) === null || _h === void 0 ? void 0 : _h[name];
...
/***/ "./node_modules/@microchip/spi-client-drv-interface/lib/package.json":
/*!***************************************************************************!*\
  !*** ./node_modules/@microchip/spi-client-drv-interface/lib/package.json ***!
  \***************************************************************************/
...
module.exports = JSON.parse("{\"name\":\"@microchip/spi-client-drv-interface\",\"version\":\"1.1.0\",\"license\":\"SEE LICENSE IN LICENSE.txt\",\"main\":\"lib/src/index.js\",\"typings\":\"./lib/src/index.d.ts\",\"scripts\":{\"build\":\"tsc\",\"test\":\"jest\",\"lint:nofix\":\"eslint \\\"./src/**/*.{ts,tsx}\\\" --quiet\",\"lint\":\"tsc --noEmit && yarn lint:nofix --fix\"},\"husky\":{\"hooks\":{\"pre-commit\":\"tsc --noEmit && lint-staged\"}},\"lint-staged\":{\"./src/**/*.{ts,tsx}\":[\"eslint --fix\"]},\"bitBucketRepository\":\"https://bitbucket.microchip.com/projects/CC16SCRIP/repos/spi-client-drv-interface/browse\",\"repository\":{\"type\":\"git\",\"url\":\"git+ssh://git@https://bitbucket.microchip.com/scm/cc16scrip/spi-client-drv-interface.git\"},\"publishConfig\":{\"registry\":\"https://artifacts.microchip.com/artifactory/api/npm/npm/\"},\"jest\":{\"testPathIgnorePatterns\":[\"/node_modules/\",\"/run/\",\"/lib/\"],\"modulePathIgnorePatterns\":[\"<rootDir>/run\"],\"preset\":\"ts-jest\",\"collectCoverage\":true},\"dependencies\":{\"@microchip/scf-common\":\"^3.17.0\",\"@microchip/scf-interface\":\"^1.4.0\",\"@microchip/spi-slave-basic\":\"^1.2.0\"},\"devDependencies\":{\"@types/jest\":\"^24.0.14\",\"@types/node\":\"^12.0.10\",\"@typescript-eslint/eslint-plugin\":\"^2.27.0\",\"@typescript-eslint/parser\":\"^2.27.0\",\"eslint\":\"^6.8.0\",\"eslint-config-prettier\":\"^6.10.1\",\"eslint-plugin-prettier\":\"^3.1.2\",\"husky\":\"^4.2.4\",\"jest\":\"^24.8.0\",\"lint-staged\":\"^10.2.0\",\"prettier\":\"^2.0.4\",\"ts-jest\":\"^24.0.2\",\"typescript\":\"^3.8.3\"},\"files\":[\"lib/**/*\"],\"notificationEmail\":\"1d0dd98b.microchiptechnology.onmicrosoft.com@amer.teams.ms\"}");

/***/ }),

/***/ "./node_modules/@microchip/spi-client-drv-interface/lib/src/index.js":
/*!***************************************************************************!*\
  !*** ./node_modules/@microchip/spi-client-drv-interface/lib/src/index.js ***!
  \***************************************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var spi_client_drv_interface_1 = __webpack_require__(/*! ./spi-client-drv-interface */ "./node_modules/@microchip/spi-client-drv-interface/lib/src/spi-client-drv-interface.js");
Object.defineProperty(exports, "Interface", { enumerable: true, get: function () { return spi_client_drv_interface_1.Interface; } });
var spi_slave_basic_1 = __webpack_require__(/*! @microchip/spi-slave-basic */ "./node_modules/@microchip/spi-slave-basic/lib/src/index.js");
Object.defineProperty(exports, "getSpiSlaveInterfaceApiStructure", { enumerable: true, get: function () { return spi_slave_basic_1.getSpiSlaveInterfaceApiStructure; } });
//# sourceMappingURL=index.js.map

/***/ }),

/***/ "./node_modules/@microchip/spi-client-drv-interface/lib/src/spi-client-drv-interface.js":
/*!**********************************************************************************************!*\
  !*** ./node_modules/@microchip/spi-client-drv-interface/lib/src/spi-client-drv-interface.js ***!
  \**********************************************************************************************/
/*! no static exports found */
...
var pkgJson = __importStar(__webpack_require__(/*! ../package.json */ "./node_modules/@microchip/spi-client-drv-interface/lib/package.json"));
var spi_slave_basic = __importStar(__webpack_require__(/*! @microchip/spi-slave-basic */ "./node_modules/@microchip/spi-slave-basic/lib/src/index.js"));
...
var createMock = function () {
    return {
        ...
        payload: {
            customName: "SPI1",
            interfaceSpiSlaveApi: spi_slave_basic.getSpiSlaveInterfaceApiStructure("SPI1"),
            moduleInstance: 1,
            moduleName: "SPI1",
            hasPolling: true,
            hasInterrupt: true,
            interruptDriven: false,
            spiSlavePayloadData: getSlavePayload(),
        },
        args: {
            requestId: {
                ...
                interruptDriven: false,
                getInterfaceSpiSlaveAPI: true,
            },
        },
    };
};
var getSlavePayload = function () {
    var slavePayloadData = [];
    var slavePayload = {
        configName: "tempSensor",
        spiMode: "Mode 0",
    };
    slavePayloadData.push(slavePayload);
    return slavePayloadData;
};
...
//# sourceMappingURL=spi-client-drv-interface.js.map

/***/ }),

/***/ "./node_modules/@microchip/spi-slave-basic/lib/package.json":
/*!******************************************************************!*\
  !*** ./node_modules/@microchip/spi-slave-basic/lib/package.json ***!
  \******************************************************************/
/*! exports provided: name, version, license, main, typings, scripts, husky, lint-staged, bitBucketRepository, repository, publishConfig, jest, dependencies, devDependencies, files, notificationEmail, default */
...
module.exports = JSON.parse("{\"name\":\"@microchip/spi-slave-basic\",\"version\":\"1.2.0\",\"license\":\"SEE LICENSE IN LICENSE.txt\",\"main\":\"lib/src/index.js\",\"typings\":\"./lib/src/index.d.ts\",\"scripts\":{\"build\":\"tsc\",\"test\":\"jest\",\"lint:nofix\":\"eslint \\\"./src/**/*.{ts,tsx}\\\" --quiet\",\"lint\":\"tsc --noEmit && yarn lint:nofix --fix\"},\"husky\":{\"hooks\":{\"pre-commit\":\"tsc --noEmit && lint-staged\"}},\"lint-staged\":{\"./src/**/*.{ts,tsx}\":[\"eslint --fix\"]},\"bitBucketRepository\":\"https://bitbucket.microchip.com/projects/SCF/repos/spi-slave-basic/browse\",\"repository\":{\"type\":\"git\",\"url\":\"git+ssh://git@https://bitbucket.microchip.com/scm/scf/spi-slave-basic.git\"},\"publishConfig\":{\"registry\":\"https://artifacts.microchip.com/artifactory/api/npm/npm/\"},\"jest\":{\"testPathIgnorePatterns\":[\"/node_modules/\",\"/run/\",\"/lib/\"],\"modulePathIgnorePatterns\":[\"<rootDir>/run\"],\"preset\":\"ts-jest\",\"collectCoverage\":true},\"dependencies\":{\"@microchip/scf-common\":\"^3.5.0\",\"@microchip/scf-interface\":\"^1.4.0\"},\"devDependencies\":{\"@types/jest\":\"^24.0.14\",\"@types/node\":\"^12.0.10\",\"@typescript-eslint/eslint-plugin\":\"^2.27.0\",\"@typescript-eslint/parser\":\"^2.27.0\",\"eslint\":\"^6.8.0\",\"eslint-config-prettier\":\"^6.10.1\",\"eslint-plugin-prettier\":\"^3.1.2\",\"husky\":\"^4.2.4\",\"jest\":\"^24.8.0\",\"lint-staged\":\"^10.2.0\",\"prettier\":\"^2.0.4\",\"ts-jest\":\"^24.0.2\",\"typescript\":\"^3.8.3\"},\"files\":[\"lib/**/*\"],\"notificationEmail\":\"1d0dd98b.microchiptechnology.onmicrosoft.com@amer.teams.ms\"}");

/***/ }),

/***/ "./node_modules/@microchip/spi-slave-basic/lib/src/api.js":
/*!****************************************************************!*\
  !*** ./node_modules/@microchip/spi-slave-basic/lib/src/api.js ***!
  \****************************************************************/
/*! no static exports found */
    ...
    return [
        {
            ...
            path: "mcc_generated_files/spi_client/",
        },
        {
            name: "spi_client_interface.h",
            path: "mcc_generated_files/spi_client/",
        },
    ];
};
...
/***/ "./node_modules/@microchip/spi-slave-basic/lib/src/index.js":
/*!******************************************************************!*\
  !*** ./node_modules/@microchip/spi-slave-basic/lib/src/index.js ***!
  \******************************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var spi_slave_basic_1 = __webpack_require__(/*! ./spi-slave-basic */ "./node_modules/@microchip/spi-slave-basic/lib/src/spi-slave-basic.js");
exports.Interface = spi_slave_basic_1.Interface;
exports.getSpiSlaveInterfaceApiStructure = spi_slave_basic_1.getSpiSlaveInterfaceApiStructure;
//# sourceMappingURL=index.js.map

/***/ }),

/***/ "./node_modules/@microchip/spi-slave-basic/lib/src/spi-slave-basic.js":
/*!****************************************************************************!*\
  !*** ./node_modules/@microchip/spi-slave-basic/lib/src/spi-slave-basic.js ***!
  \****************************************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var InterfaceTypes = __importStar(__webpack_require__(/*! @microchip/scf-interface */ "./node_modules/@microchip/scf-interface/lib/index.js"));
var pkgJson = __importStar(__webpack_require__(/*! ../package.json */ "./node_modules/@microchip/spi-slave-basic/lib/package.json"));
var api_1 = __webpack_require__(/*! ./api */ "./node_modules/@microchip/spi-slave-basic/lib/src/api.js");
exports.getSpiSlaveInterfaceApiStructure = function (moduleName) {
    return {
        api: api_1.getSpiAPI(),
...
var createMock = function () {
    return {
        interfaceId: getInterfaceId(),
        payload: {
            interfaceSpiSlaveApi: exports.getSpiSlaveInterfaceApiStructure("SPI1"),
            moduleInstance: 1,
            moduleName: "SPI1",
            hasPolling: true,
            hasInterrupt: true,
...
//# sourceMappingURL=spi-slave-basic.js.map
...
/* harmony import */ var _exports_spiClientDrvInterface__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./exports/spiClientDrvInterface */ "./src/exports/spiClientDrvInterface.ts");
/* harmony import */ var _microchip_scf_validators_lib__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @microchip/scf-validators/lib */ "./node_modules/@microchip/scf-validators/lib/index.js");
/* harmony import */ var _microchip_scf_validators_lib__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_microchip_scf_validators_lib__WEBPACK_IMPORTED_MODULE_3__);
...
var MyDerivedData = function MyDerivedData(dataModel) {
  ...
  _defineProperty(this, "cValidator", Object(_microchip_scf_validators_lib__WEBPACK_IMPORTED_MODULE_3__["getCFunctionValidator"])());

  _defineProperty(this, "getMyFunctions", function () {
    return {
      moduleName: _this.getModuleName,
      alerts: _this.getMyAlerts,
      spi_slave_basic_args: _this.getBasicSpiSlaveArgs,
      spi_slave_basic_results: _this.getBasicSPISlaveResults,
      ...
      spiClientTable: _this.getSpiClientTable,
      importerConfigTable: _this.getImporterTable,
      "spi-client-drv-interface_payload": _this.getSpiClientDrvPayload,
  ...
  _defineProperty(this, "overrideModuleLevelHelp", function () {
    ...
    switch (deviceArch) {
      case "DSPIC33A":
        return {
          url: "v2/keyword-lookup?keyword=SPI_CLIENT_33A_MELODY_DRIVER&version=latest&redirect=true",
      ...
      default:
        return {
          url: "v2/keyword-lookup?keyword=SPI_CLIENT_MELODY_DRIVER&version=latest&redirect=true",
          tooltip: "Click here to open SPI API documentation"
        };
    }
  });

  _defineProperty(this, "getImporterTable", function (table, model, tab) {
    return _this.getImporterRowData();
  });

  _defineProperty(this, "getImporterRowData", function () {
    var _this$dataModel, _this$dataModel$getSt, _this$dataModel$getSt2, _this$dataModel$getSt3;

    var tableState = (_this$dataModel = _this.dataModel) === null || _this$dataModel === void 0 ? void 0 : (_this$dataModel$getSt = _this$dataModel.getState()) === null || _this$dataModel$getSt === void 0 ? void 0 : (_this$dataModel$getSt2 = _this$dataModel$getSt.main) === null || _this$dataModel$getSt2 === void 0 ? void 0 : (_this$dataModel$getSt3 = _this$dataModel$getSt2.software) === null || _this$dataModel$getSt3 === void 0 ? void 0 : _this$dataModel$getSt3.importerConfigTable;
    return Object(_SpiDataTable__WEBPACK_IMPORTED_MODULE_1__["createImporterTableRowData"])(tableState, _this.dataModel);
  });
  ...
  _defineProperty(this, "getSpiClientDrvPayload", function () {
    var interfaceData = _this.dataModel.getImportValue("spi_slave_basic");

    if (interfaceData !== undefined) {
      var _this$dataModel$getCo, _this$dataModel2;

      return _objectSpread({}, interfaceData, {
        customName: (_this$dataModel$getCo = (_this$dataModel2 = _this.dataModel) === null || _this$dataModel2 === void 0 ? void 0 : _this$dataModel2.getComponentValue("customName")) !== null && _this$dataModel$getCo !== void 0 ? _this$dataModel$getCo : ""
      });
    }
  ...
  _defineProperty(this, "getSpiClientTable", function (table, model, tab) {
    return _this.getTableRowData();
  });
  ...
  _defineProperty(this, "getTableRowData", function () {
    ...
    var tableState = (_this$dataModel3 = _this.dataModel) === null || _this$dataModel3 === void 0 ? void 0 : (_this$dataModel3$getS = _this$dataModel3.getState()) === null || _this$dataModel3$getS === void 0 ? void 0 : (_this$dataModel3$getS2 = _this$dataModel3$getS.main) === null || _this$dataModel3$getS2 === void 0 ? void 0 : (_this$dataModel3$getS3 = _this$dataModel3$getS2.software) === null || _this$dataModel3$getS3 === void 0 ? void 0 : _this$dataModel3$getS3.spiClientTable;
    return Object(_SpiDataTable__WEBPACK_IMPORTED_MODULE_1__["createTableRowData"])(tableState, _this.dataModel);
  });
  ...
  _defineProperty(this, "getActiveName", function () {
    ...
    var processedPayloadVal = _this.dataModel.getImportValue("spi_slave_basic");

    if ((processedPayloadVal === null || processedPayloadVal === void 0 ? void 0 : processedPayloadVal.moduleInstance) != undefined) {
      var _this$dataModel$getCo2, _this$dataModel4;

      return (_this$dataModel$getCo2 = (_this$dataModel4 = _this.dataModel) === null || _this$dataModel4 === void 0 ? void 0 : _this$dataModel4.getComponentValue("customName")) !== null && _this$dataModel$getCo2 !== void 0 ? _this$dataModel$getCo2 : "";
    }
  ...
  _defineProperty(this, "filterMyImports", function (imports) {
    var _filteredImports$spi_;

    var filteredImports = _this.dataModel.filterImportBySetting(imports, "spi_slave_basic", function (option) {
      return true;
    });

    if (filteredImports === null || filteredImports === void 0 ? void 0 : (_filteredImports$spi_ = filteredImports.spi_slave_basic) === null || _filteredImports$spi_ === void 0 ? void 0 : _filteredImports$spi_.options) {
      filteredImports.spi_slave_basic.options.sort(function (importOption1, importOption2) {
  ...
  _defineProperty(this, "friendlyImportOptionLabels", function (importKey, option) {
    ...
    if (importKey === "spi_slave_basic" && (option === null || option === void 0 ? void 0 : (_option$payload = option.payload) === null || _option$payload === void 0 ? void 0 : _option$payload.moduleName)) {
  ...
  _defineProperty(this, "getBasicSPISlaveResults", function () {
    return {
  ...
  _defineProperty(this, "getModuleName", function () {
    var _this$dataModel$getCo3, _this$dataModel6;

    return (_this$dataModel$getCo3 = (_this$dataModel6 = _this.dataModel) === null || _this$dataModel6 === void 0 ? void 0 : _this$dataModel6.getComponentValue("customName")) !== null && _this$dataModel$getCo3 !== void 0 ? _this$dataModel$getCo3 : "";
  });

  _defineProperty(this, "overrideDefaultValue", function (componentName) {
    if (componentName === "customName") {
      var customName = Object(_exports_spiClientDrvInterface__WEBPACK_IMPORTED_MODULE_2__["getSpiClientDrvRequestedArg"])("customName", _this.dataModel);
      ...
      if ((processedPayloadVal === null || processedPayloadVal === void 0 ? void 0 : processedPayloadVal.moduleInstance) != undefined) {
        return "SPI".concat(processedPayloadVal.moduleInstance, "_Client");
      }
    }

    if (componentName === "interruptDriven") {
      var _processedPayloadVal = _this.dataModel.getImportValue("spi_slave_basic");

      if ((_processedPayloadVal === null || _processedPayloadVal === void 0 ? void 0 : _processedPayloadVal.hasPolling) && (_processedPayloadVal === null || _processedPayloadVal === void 0 ? void 0 : _processedPayloadVal.hasInterrupt)) {
        return Object(_exports_spiClientDrvInterface__WEBPACK_IMPORTED_MODULE_2__["getSpiClientDrvInterruptDriven"])(_this.getModel());
      }

      return !(_processedPayloadVal === null || _processedPayloadVal === void 0 ? void 0 : _processedPayloadVal.hasPolling) && (_processedPayloadVal === null || _processedPayloadVal === void 0 ? void 0 : _processedPayloadVal.hasInterrupt);
    }

    return undefined;
  });

  _defineProperty(this, "getBasicSpiSlaveArgs", function () {
    var _ref, _this$dataModel$getSt4, _this$dataModel$getSt5, _this$dataModel$getSt6, _this$dataModel$getSt7;

    var rowData = [].concat(_toConsumableArray(_this.getTableRowData()), _toConsumableArray(_this.getImporterRowData()));
    var spiClientEntry = rowData.map(_SpiDataTable__WEBPACK_IMPORTED_MODULE_1__["getSpiRowSlaveArg"]);
    return {
      spiSlaveArgData: spiClientEntry,
      getInterfaceSpiSlaveAPI: Object(_exports_spiClientDrvInterface__WEBPACK_IMPORTED_MODULE_2__["getSpiClientDrvIntfApiRequest"])(_this.dataModel),
      interruptDriven: (_ref = (_this$dataModel$getSt4 = (_this$dataModel$getSt5 = _this.dataModel.getState()) === null || _this$dataModel$getSt5 === void 0 ? void 0 : (_this$dataModel$getSt6 = _this$dataModel$getSt5.main) === null || _this$dataModel$getSt6 === void 0 ? void 0 : (_this$dataModel$getSt7 = _this$dataModel$getSt6.interrupt) === null || _this$dataModel$getSt7 === void 0 ? void 0 : _this$dataModel$getSt7.interruptDriven) !== null && _this$dataModel$getSt4 !== void 0 ? _this$dataModel$getSt4 : Object(_exports_spiClientDrvInterface__WEBPACK_IMPORTED_MODULE_2__["getSpiClientDrvInterruptDriven"])(_this.getModel())) !== null && _ref !== void 0 ? _ref : false
    };
  });
  ...
  _defineProperty(this, "getMyAlerts", function () {
    ...
    var isImportAssigned = _this.dataModel.getImportValue("spi_slave_basic");

    if (isImportAssigned) {
      var slaveDataList = [].concat(_toConsumableArray(_this.getTableRowData()), _toConsumableArray(_this.getImporterRowData()));
      var isSlaveNameEmpty = false;
      var slaveNameEntrySet = [];
      slaveDataList.forEach(function (slaveRow) {
        if (!slaveRow.configName) {
          isSlaveNameEmpty = true;
        } else if (!Object(_SpiDataTable__WEBPACK_IMPORTED_MODULE_1__["isElementPresent"])(slaveNameEntrySet, slaveRow.configName)) {
      ...
      var invalidCNameList = slaveNameEntrySet.filter(function (configName) {
      ...
      if (invalidCNameList.length > 0) {
        ...
        if (invalidCNameList.length > 1) {
          var lastEntry = invalidCNameList.pop();
          text = "".concat(invalidCNameList.join(","), " and ").concat(lastEntry, " are invalid Config Name entries, incompatible with C compiler.");
        } else {
          text = "".concat(invalidCNameList[0], " is an invalid Config Name entry, incompatible with C compiler.");
        }
      ...
      alerts.push.apply(alerts, _toConsumableArray(Object(_exports_spiClientDrvInterface__WEBPACK_IMPORTED_MODULE_2__["getSpiClientDrvAlerts"])(_this.getModel())));
    }
  ...
  _defineProperty(this, "getDynamicConfigData", function (config) {
    ...
    if (updatedConfig === null || updatedConfig === void 0 ? void 0 : (_updatedConfig$softwa = updatedConfig.softwareData) === null || _updatedConfig$softwa === void 0 ? void 0 : (_updatedConfig$softwa2 = _updatedConfig$softwa.importerConfigTable) === null || _updatedConfig$softwa2 === void 0 ? void 0 : _updatedConfig$softwa2.description) {
      var importerNames = Object(_exports_spiClientDrvInterface__WEBPACK_IMPORTED_MODULE_2__["getAllSpiClientDrvImporterNames"])(_this.getModel());
...
/*!******************************!*\
  !*** ./src/SpiDataTable.tsx ***!
  \******************************/
/*! exports provided: DEFAULT_MODE, DEFAULT_CONFIG_NAME, TABLE_NAME, TABLE_PATH, TABLE_TAB_ID, getSpiRowSlaveArg, isElementPresent, getActionData, getColumnAction, getRowData, getDefaultRowData, getRowEntryFromDrvIntfArg, getDriverInterfaceRows, createImporterTableRowData, createTableRowData */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getSpiRowSlaveArg", function() { return getSpiRowSlaveArg; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createImporterTableRowData", function() { return createImporterTableRowData; });
...
/* harmony import */ var _exports_spiClientDrvInterface__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./exports/spiClientDrvInterface */ "./src/exports/spiClientDrvInterface.ts");


var DEFAULT_MODE = "Mode 1";
var DEFAULT_CONFIG_NAME = "CLIENT_CONFIG";
var TABLE_NAME = "spiClientTable";
var TABLE_PATH = "software.spiClientTable";
var TABLE_TAB_ID = "main";
var getSpiRowSlaveArg = function getSpiRowSlaveArg(rowStateData) {
  var _rowStateData$configN, _rowStateData$spiMode;
...
var getRowData = function getRowData(rowEntry) {
  var _rowEntry$configName, _rowEntry$spiMode;
...
var getRowEntryFromDrvIntfArg = function getRowEntryFromDrvIntfArg(slaveArgData, importerName) {
  return {
    uid: "".concat(_microchip_melody_automodule_interface_lib_src_Tables__WEBPACK_IMPORTED_MODULE_0__["RowPrefix"].Dynamic).concat(importerName, "_").concat(slaveArgData.configName),
...
var getDriverInterfaceRows = function getDriverInterfaceRows(dataModel) {
  var drvIntfConfigRequests = Object(_exports_spiClientDrvInterface__WEBPACK_IMPORTED_MODULE_1__["getSpiClientDrvIntfConfigRequests"])(dataModel);
  var importerName = Object(_exports_spiClientDrvInterface__WEBPACK_IMPORTED_MODULE_1__["getSpiClientDrvRequestedArg"])("importerName", dataModel);
  return drvIntfConfigRequests.map(function (request) {
    return getRowEntryFromDrvIntfArg(request, importerName);
  });
};
var createImporterTableRowData = function createImporterTableRowData(tableState, dataModel) {
  var rowData = tableState !== null && tableState !== void 0 ? tableState : [];
  var spiClientRowData = getDriverInterfaceRows(dataModel);
  spiClientRowData.forEach(function (currentRow) {
    var matchingRows = rowData.filter(function (rowEntry) {
      return rowEntry.uid === currentRow.uid;
    });
...
var createTableRowData = function createTableRowData(tableState, dataModel) {
  var updatedRowData = [];
  var rowData = tableState !== null && tableState !== void 0 ? tableState : [];
  ...
  var importerRowData = getDriverInterfaceRows(dataModel);
...
/***/ "./src/exports/spiClientDrvInterface.ts":
/*!**********************************************!*\
  !*** ./src/exports/spiClientDrvInterface.ts ***!
  \**********************************************/
/*! exports provided: spi_client_drv_interface, getSpiClientDrvRequestedCustomNames, getSpiClientDrvExportArgs, getSpiClientDrvRequestedArg, getSpiClientDrvIntfApiRequest, getSpiClientDrvIntfConfigRequests, getSpiClientDrvAlerts, getAllSpiClientDrvImporterNames, getSpiClientDrvInterruptDriven */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getSpiClientDrvRequestedCustomNames", function() { return getSpiClientDrvRequestedCustomNames; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getSpiClientDrvExportArgs", function() { return getSpiClientDrvExportArgs; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getSpiClientDrvRequestedArg", function() { return getSpiClientDrvRequestedArg; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getSpiClientDrvIntfApiRequest", function() { return getSpiClientDrvIntfApiRequest; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getSpiClientDrvIntfConfigRequests", function() { return getSpiClientDrvIntfConfigRequests; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getSpiClientDrvAlerts", function() { return getSpiClientDrvAlerts; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getAllSpiClientDrvImporterNames", function() { return getAllSpiClientDrvImporterNames; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getSpiClientDrvInterruptDriven", function() { return getSpiClientDrvInterruptDriven; });
/* harmony import */ var _microchip_scf_common_lib_Processor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @microchip/scf-common/lib/Processor */ "./node_modules/@microchip/scf-common/lib/Processor.js");
/* harmony import */ var _microchip_scf_common_lib_Processor__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_microchip_scf_common_lib_Processor__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _microchip_spi_client_drv_interface__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @microchip/spi-client-drv-interface */ "./node_modules/@microchip/spi-client-drv-interface/lib/src/index.js");
/* harmony import */ var _microchip_spi_client_drv_interface__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_microchip_spi_client_drv_interface__WEBPACK_IMPORTED_MODULE_1__);
/* harmony reexport (module object) */ __webpack_require__.d(__webpack_exports__, "spi_client_drv_interface", function() { return _microchip_spi_client_drv_interface__WEBPACK_IMPORTED_MODULE_1__; });
...
var getSpiClientDrvRequestedCustomNames = function getSpiClientDrvRequestedCustomNames(dataModel) {
  var args = getSpiClientDrvExportArgs(_microchip_spi_client_drv_interface__WEBPACK_IMPORTED_MODULE_1__["Interface"], dataModel);
...
var getSpiClientDrvExportArgs = function getSpiClientDrvExportArgs(intf, dataModel) {
  var _dataModel$getExportI;

  return (_dataModel$getExportI = dataModel.getExportInterfaces().getInterface("spi_client_drv_interface", intf.getInterfaceId())) === null || _dataModel$getExportI === void 0 ? void 0 : _dataModel$getExportI.args;
};

var getSpiClientDrvRequestedArg = function getSpiClientDrvRequestedArg(componentName, dataModel) {
  var args = getSpiClientDrvExportArgs(_microchip_spi_client_drv_interface__WEBPACK_IMPORTED_MODULE_1__["Interface"], dataModel);
...
var getSpiClientDrvIntfApiRequest = function getSpiClientDrvIntfApiRequest(dataModel) {
  return getSpiClientDrvRequestedArg("getInterfaceSpiSlaveAPI", dataModel);
};

var getSpiClientDrvIntfConfigRequests = function getSpiClientDrvIntfConfigRequests(dataModel) {
  var _getSpiClientDrvReque;

  return (_getSpiClientDrvReque = getSpiClientDrvRequestedArg("spiSlaveArgData", dataModel)) !== null && _getSpiClientDrvReque !== void 0 ? _getSpiClientDrvReque : [];
};

var getSpiClientDrvInterruptDriven = function getSpiClientDrvInterruptDriven(dataModel) {
  return getSpiClientDrvRequestedArg("interruptDriven", dataModel);
};

var getSpiClientDrvAlerts = function getSpiClientDrvAlerts(dataModel) {
  var customName = dataModel.getComponentValue("customName");
  var requestedCustomNameArgs = getSpiClientDrvRequestedCustomNames(dataModel);
  var rejectedCustomNameArgs = requestedCustomNameArgs.filter(function (name) {
    return name.customName !== customName;
  });
  var isUserInputted = rejectedCustomNameArgs.length === requestedCustomNameArgs.length;
  var modifiedBy = isUserInputted ? "user input" : "importer given";

  if (rejectedCustomNameArgs.length > 0) {
    return [{
      type: _microchip_scf_common_lib_Processor__WEBPACK_IMPORTED_MODULE_0__["AlertTypes"].Hint,
      text: "For Custom Name field, ".concat(rejectedCustomNameArgs.map(function (args) {
        return "\"".concat(args.customName, "\" was requested by \"").concat(args.importerName, "\"");
      }).join(", "), ", but the field is being updated based on ").concat(modifiedBy, " \"").concat(customName, "\"")
    }];
  }
...
var getAllSpiClientDrvRequestedArgs = function getAllSpiClientDrvRequestedArgs(componentName, dataModel) {
  var args = getSpiClientDrvExportArgs(_microchip_spi_client_drv_interface__WEBPACK_IMPORTED_MODULE_1__["Interface"], dataModel);
...
var getAllSpiClientDrvImporterNames = function getAllSpiClientDrvImporterNames(dataModel) {
  return getAllSpiClientDrvRequestedArgs("importerName", dataModel);
};
...
/*!*******************************!*\
  !*** ./src/moduleConfig.json ***!
  \*******************************/
/*! exports provided: moduleName, deviceType, booleanValues, help, UIGroups, UIOrder, tabs, templates, displayViewOnImportAssigned, imports, exports, softwareData, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"moduleName\":\"SPI Client\",\"deviceType\":\"PIC\",\"booleanValues\":{\"true\":\"enabled\",\"false\":\"disabled\"},\"help\":{\"url\":\"v2/keyword-lookup?keyword=SPI_CLIENT_MELODY_DRIVER&version=latest&redirect=true\",\"tooltip\":\"Click here to open documentation\"},\"UIGroups\":{\"software\":\"Software Settings\",\"interrupt\":\"Interrupt Settings\",\"dependency\":\"Dependency Selector\"},\"UIOrder\":{\"software\":[\"*\"],\"interrupt\":[\"*\"]},\"tabs\":{\"main\":\"Easy View\"},\"templates\":[],\"displayViewOnImportAssigned\":[\"spi_slave_basic\"],\"imports\":{\"spi_slave_basic\":{\"nodeModule\":{\"importName\":\"spi_slave_basic\",\"node\":\"@microchip/spi-slave-basic\"},\"import\":{\"interfaceId\":{\"name\":\"spi-slave-basic\",\"version\":\"^1.1.0\"}}},\"device_meta\":{\"import\":{\"interfaceId\":{\"name\":\"device-meta\",\"version\":\"^1.0.0\"}}}},\"exports\":{\"spi_client_drv_interface\":{\"interfaces\":[{\"interfaceId\":{\"name\":\"spi-client-drv-interface\",\"version\":\"1.1.0\"}}],\"handleLimit\":1}},\"softwareData\":{\"customName\":{\"name\":\"customName\",\"description\":\"Custom Name\",\"type\":\"string\",\"defaultValue\":\"SPI_Client\",\"group\":\"software\",\"tabs\":[\"main\"],\"validation\":true,\"category\":\"software\"},\"importerConfigTable\":{\"name\":\"importerConfigTable\",\"description\":\"Middleware Configurations\",\"category\":\"table\",\"type\":\"object\",\"group\":\"software\",\"tabs\":[\"main\"],\"displayHeadersHorizontally\":true,\"columns\":{\"configName\":{\"readonly\":true,\"title\":\"Config Name\",\"type\":\"string\",\"defaultValue\":\"CLIENT_CONFIG\"},\"spiMode\":{\"readonly\":true,\"title\":\"Mode\",\"type\":\"ComboBox\",\"defaultValue\":{\"value\":\"Mode 1\",\"options\":[\"Mode 0\",\"Mode 1\",\"Mode 2\",\"Mode 3\"]}}},\"isVisibleProperty\":\"isSpiInterfaceTableUsed\",\"defaultRowNum\":0,\"rowData\":[],\"canAddRows\":false,\"canRemoveRows\":false},\"spiClientTable\":{\"name\":\"spiClientTable\",\"description\":\"User Configurations\",\"category\":\"table\",\"type\":\"object\",\"group\":\"software\",\"tabs\":[\"main\"],\"displayHeadersHorizontally\":true,\"columns\":{\"configName\":{\"title\":\"Config Name\",\"type\":\"string\",\"defaultValue\":\"CLIENT_CONFIG\"},\"spiMode\":{\"title\":\"Mode\",\"type\":\"ComboBox\",\"defaultValue\":{\"value\":\"Mode 1\",\"options\":[\"Mode 0\",\"Mode 1\",\"Mode 2\",\"Mode 3\"]}}},\"defaultRowNum\":0,\"rowData\":[],\"canAddRows\":true,\"canRemoveRows\":true},\"depSelector\":{\"name\":\"depSelector\",\"category\":\"import\",\"description\":\"SPI Client PLIB Selector\",\"type\":\"ComboBox\",\"group\":\"dependency\",\"importId\":\"spi_slave_basic\",\"tabs\":[\"main\"]},\"interruptDriven\":{\"name\":\"interruptDriven\",\"description\":\"Interrupt Driven\",\"type\":\"boolean\",\"defaultValue\":false,\"group\":\"interrupt\",\"tabs\":[\"main\"],\"category\":\"software\",\"mode\":{\"masterComponent\":\"\",\"matchRegEx\":\"\",\"operation\":\"isEnabled\"}}}}");
